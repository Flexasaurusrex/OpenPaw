...
For images, OpenPaw downscales transcript/tool image payloads before provider calls.
...
Anthropic's 1M context window is currently beta-gated. OpenPaw can inject the
