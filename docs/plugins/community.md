...
read_when:
  - You want to publish a third-party OpenPaw plugin
...
This page tracks high-quality **community-maintained plugins** for OpenPaw.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `openpaw plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `openpaw plugins install @scope/package`
