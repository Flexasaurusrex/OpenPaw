...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure OpenPaw HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `openpaw pairing approve slack <code>`.
...
OpenPaw supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, OpenPaw falls back to normal delivery for remaining payloads.
