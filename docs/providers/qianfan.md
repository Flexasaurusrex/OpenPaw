---
summary: "Use Qianfan's unified API to access many models in OpenPaw"
read_when:
...
3. OpenPaw installed on your system
...
4. Copy the API key for use with OpenPaw

## CLI setup

```bash
openpaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [OpenPaw Configuration](/gateway/configuration)
