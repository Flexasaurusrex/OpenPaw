...
```bash
openpaw agent --model venice/llama-3.3-70b --message "Hello, are you working?"
```
...
openpaw agent --model venice/llama-3.3-70b --message "Quick health check"

# Use Claude via Venice (anonymized)
openpaw agent --model venice/claude-opus-45 --message "Summarize this task"

# Use uncensored model
openpaw agent --model venice/venice-uncensored --message "Draft options"

# Use vision model with image
openpaw agent --model venice/qwen3-vl-235b-a22b --message "Review attached image"

# Use coding model
openpaw agent --model venice/qwen3-coder-480b-a35b-instruct --message "Refactor this function"
```
