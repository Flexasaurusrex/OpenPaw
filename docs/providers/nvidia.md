---
summary: "Use NVIDIA's OpenAI-compatible API in OpenPaw"
read_when:
  - You want to use NVIDIA models in OpenPaw
...
openpaw onboard --auth-choice skip
openpaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
