---
summary: "Overview of OpenPaw onboarding options and flows"
read_when:
...
OpenPaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`openpaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the OpenPaw app when you want a fully guided setup on macOS. Docs:
