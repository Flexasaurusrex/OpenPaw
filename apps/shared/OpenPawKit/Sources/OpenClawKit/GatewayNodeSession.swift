...
public actor GatewayNodeSession {
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.openpaw", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: OpenPawProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
