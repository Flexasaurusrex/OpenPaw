...
public enum OpenPawCanvasA2UICommand: String, Codable, Sendable {
...
public struct OpenPawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct OpenPawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
