...
public enum OpenPawTalkCommand: String, Codable, Sendable {
...
public struct OpenPawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct OpenPawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
