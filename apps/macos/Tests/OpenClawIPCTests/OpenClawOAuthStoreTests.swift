...
struct OpenPawOAuthStoreTests {
    ...
    func returnsMissingWhenFileAbsent() {
        ...
        #expect(OpenPawOAuthStore.anthropicOAuthStatus(at: url) == .missingFile)
    }

    @Test
    func usesEnvOverrideForOpenPawOAuthDir() throws {
        ...
        #expect(OpenPawOAuthStore.oauthDir().standardizedFileURL == dir.standardizedFileURL)
    }
    ...
    func acceptsPiFormatTokens() throws {
        ...
        #expect(OpenPawOAuthStore.anthropicOAuthStatus(at: url).isConnected)
    }
    ...
    func reportsMissingProviderEntry() throws {
        ...
        #expect(OpenPawOAuthStore.anthropicOAuthStatus(at: url) == .missingProviderEntry)
    }
    ...
    func reportsMissingTokens() throws {
        ...
        #expect(OpenPawOAuthStore.anthropicOAuthStatus(at: url) == .missingTokens)
    }
