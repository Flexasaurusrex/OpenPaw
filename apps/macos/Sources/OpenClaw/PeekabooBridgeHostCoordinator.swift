...
final class PeekabooBridgeHostCoordinator {
    ...
    private var services: OpenPawPeekabooBridgeServices?
    private static var openpawSocketPath: String {
    ...
    private func startIfNeeded() async {
        ...
        let services = OpenPawPeekabooBridgeServices()
        ...
        let host = PeekabooBridgeHost(
            socketPath: Self.openpawSocketPath,
            server: server,
        ...
        await host.start()
        self.logger
            .info("PeekabooBridge host started at \(Self.openpawSocketPath, privacy: .public)")
    }
...
@MainActor
private final class OpenPawPeekabooBridgeServices: PeekabooBridgeServiceProviding {
