...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .openpawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OpenPawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OpenPawPaths.stateDirURL.path
...
extension Notification.Name {
    static let openpawSelectSettingsTab = Notification.Name("openpawSelectSettingsTab")
}
