...
final class WorkActivityStore {
    ...
    func handleTool(
        ...
        name: String?,
        meta: String?,
        args: [String: OpenPawProtocol.AnyCodable]?)
    {
    ...
    private static func buildLabel(
        name: String?,
        meta: String?,
        args: [String: OpenPawProtocol.AnyCodable]?) -> String
    {
    ...
    private static func wrapToolArgs(_ args: [String: OpenPawProtocol.AnyCodable]?) -> OpenPawKit.AnyCodable? {
    ...
    private static func unwrapJSONValue(_ value: Any) -> Any {
        if let dict = value as? [String: OpenPawProtocol.AnyCodable] {
            return dict.mapValues { self.unwrapJSONValue($0.value) }
        }
        if let array = value as? [OpenPawProtocol.AnyCodable] {
