...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: OpenPawOAuthStore.AnthropicOAuthStatus = OpenPawOAuthStore
...
enum OpenPawOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let openpawOAuthDirEnv = "OPENPAW_OAUTH_DIR"
    ...
    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.openpawOAuthDirEnv]?
        ...
        return home.appendingPathComponent(".openpaw", isDirectory: true)
