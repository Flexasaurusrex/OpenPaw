...
private struct LocationAccessSettings: View {
    @AppStorage(locationModeKey) private var locationModeRaw: String = OpenPawLocationMode.off.rawValue
    ...
    private var locationMode: OpenPawLocationMode {
        OpenPawLocationMode(rawValue: self.locationModeRaw) ?? .off
    }

    private func requestLocationAuthorization(mode: OpenPawLocationMode) async -> Bool {
