...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: OpenPawOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: OpenPawChatViewModel
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: OpenPawChatViewModel(
