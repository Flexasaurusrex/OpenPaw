...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: OpenPawPhotosLatestParams) async throws -> OpenPawPhotosLatestPayload {
        ...
        var results: [OpenPawPhotoPayload] = []
        ...
        return OpenPawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> OpenPawPhotoPayload
    {
