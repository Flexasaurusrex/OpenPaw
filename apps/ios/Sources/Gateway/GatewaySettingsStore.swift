...
enum GatewaySettingsStore {
    ...
    private static let talkService = "ai.openpaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.openpaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.openpaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("openpaw-gateway.log")
    }
