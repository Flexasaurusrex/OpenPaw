...
import { b as resolveOpenPawAgentDir, i as resolveApiKeyForProvider, j as normalizeProviderId, r as requireApiKey, z as normalizeGoogleModelId } from "./model-auth-HfI5mzXM.js";
import { f as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, h as resolveIMessageAttachmentRoots, m as mergeInboundPathRoots, n as loadConfig, p as isInboundPathAllowed } from "./config-CMa41IiH.js";
import { t as describeImageWithModel, w as ensureOpenPawModelsJson } from "./image-B0TQNzq1.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-73sdiQ0s.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-rhnhxng4.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenPawAgentDir());
