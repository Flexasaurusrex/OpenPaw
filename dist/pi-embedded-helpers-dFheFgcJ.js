...
import { R as canonicalizeMainSessionAlias, W as acquireSessionWriteLock, z as resolveAgentMainSessionKey } from "./sessions-QcEz4fnW.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DodPz1PK.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-DodPz1PK.js")).closePlaywrightBrowserConnection();
		} catch {}
