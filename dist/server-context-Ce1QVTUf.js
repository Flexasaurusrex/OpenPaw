...
import { i as loadConfig, l as writeConfigFile, r as createConfigIO } from "./config-BrzzL48f.js";
import { A as DEFAULT_OPENPAW_BROWSER_PROFILE_NAME, D as DEFAULT_BROWSER_EVALUATE_ENABLED, E as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, O as DEFAULT_OPENPAW_BROWSER_COLOR, S as stopChromeExtensionRelayServer, _ as fetchJson, a as resolveOpenPawUserDataDir, d as normalizeCdpWsUrl, g as appendCdpPath, h as withBrowserNavigationPolicy, i as launchOpenPawChrome, k as DEFAULT_OPENPAW_BROWSER_ENABLED, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenPawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, v as fetchOk, x as ensureChromeExtensionRelayServer } from "./chrome-CzcXboc0.js";
import { i as isLoopbackHost } from "./ws-DI10x-Zu.js";
import { a as resolveGatewayAuth } from "./auth-DiCh-IhS.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-DZpIsD32.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-B0RW8nRr.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-B0RW8nRr.js")).closePlaywrightBrowserConnection();
		} catch {}
