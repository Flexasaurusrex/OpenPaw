import { m as resolveAgentModelPrimaryValue, p as resolveAgentModelFallbackValues } from "./agent-scope-CG5fO1-r.js";
import { J as logVerbose, Z as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-CrsB6DNT.js";
import { _ as runExec } from "./workspace--8oeKjX4.js";
import { t as normalizeChatType } from "./chat-type-uz-WJTy4.js";
import { _ as kindFromMime, d as detectMime, h as isAudioFileName, p as getFileExtension } from "./image-ops-BBKt0mGX.js";
import { b as resolveOpenPawAgentDir, i as resolveApiKeyForProvider, j as normalizeProviderId, r as requireApiKey, z as normalizeGoogleModelId } from "./model-auth-BcCFChCF.js";
import { f as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, h as resolveIMessageAttachmentRoots, m as mergeInboundPathRoots, n as loadConfig, p as isInboundPathAllowed } from "./config-Bd-EiYyt.js";
import { t as describeImageWithModel, w as ensureOpenPawModelsJson } from "./image--q1yQfhs.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-CmIr6IJd.js";
import { n as fetchWithTimeout } from "./fetch-timeout-BheTNyes.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-wffrbAvN.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-zBApnRPv.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-iA2N6RfZ.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenPawAgentDir());
