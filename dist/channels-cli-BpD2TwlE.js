...
import { B as theme, O as danger, P as setVerbose, U as getResolvedLoggerSettings, d as isRecord } from "./utils-CLEQvfyB.js";
import "./thinking-EAliFiVK.js";
import { Ct as formatUsageReportLines, St as loadProviderUsageSummary, yt as deleteTelegramUpdateOffset } from "./reply-D_97LfkS.js";
...
import { h as normalizeAccountId, m as DEFAULT_ACCOUNT_ID } from "./session-key-Dx_ARweb.js";
import "./exec-DkdDR1S0.js";
import { Nt as loadAuthProfileStore } from "./model-selection-DLFgSmxJ.js";
...
import { $ as parseDiscordTarget, bt as fetchChannelPermissionsDiscord } from "./send-Du6jbKSv.js";
...
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin, u as resolveTelegramAccount } from "./plugins-PixIvqwD.js";
...
import { i as createSlackWebClient } from "./send-BEQ3oqqE.js";
...
import { r as listChannelPluginCatalogEntries } from "./catalog-C4xsp0lG.js";
import "./plugin-registry-Dd1JRo2u.js";
import { t as formatCliChannelOptions } from "./channel-options-BacuAyep.js";
...
import { a as reloadOnboardingPluginRegistry, i as ensureOnboardingPluginInstalled, r as setupChannels } from "./onboard-channels-D9ss7hvZ.js";
...
function registerChannelsCli(program) {
	...
	const channels = program.command("channels").description("Manage connected chat channels and accounts").addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatHelpExamples([
		["openpaw channels list", "List configured channels and auth profiles."],
		["openpaw channels status --probe", "Run channel status checks and probes."],
		["openpaw channels add --channel telegram --token <token>", "Add or update a channel account non-interactively."],
		["openpaw channels login --channel whatsapp", "Link a WhatsApp Web account."]
	])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/channels", "docs.openpaw.ai/cli/channels")}\n`);
