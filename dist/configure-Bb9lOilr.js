...
import { t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-5liSMgvV.js";
import { S as shortenHomePath, y as resolveUserPath } from "./utils-CLEQvfyB.js";
import { f as defaultRuntime } from "./subsystem-BlU6Lg5x.js";
import { Mt as ensureAuthProfileStore } from "./model-selection-DLFgSmxJ.js";
import { t as formatCliCommand } from "./command-format-BMHSLXMa.js";
import { i as loadConfig, l as writeConfigFile, o as readConfigFileSnapshot } from "./config-D2VtfSUL.js";
import { a as findTailscaleBinary } from "./tailscale-DNuh1EXL.js";
import { n as listChannelPlugins, t as getChannelPlugin } from "./plugins-PixIvqwD.js";
import { n as withProgress } from "./progress-BrNyn1gy.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, g as resolveControlUiLinks, h as randomToken, m as probeGatewayReachable, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput, v as summarizeExistingConfig, y as validateGatewayPasswordInput } from "./onboard-helpers-C5liWlpx.js";
...
import { r as setupChannels, t as noteChannelStatus } from "./onboard-channels-D9ss7hvZ.js";
...
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CNr0fISG.js";
...
import { i as applyAuthChoice, n as resolvePreferredProviderForAuthChoice } from "./auth-choice-CAhCq6sk.js";
import { a as promptDefaultModel, n as applyModelFallbacksFromSelection, o as promptModelAllowlist, r as applyPrimaryModel, t as applyModelAllowlist } from "./model-picker-Dpm45Jn1.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-vJVhrluo.js";
import { a as promptCustomApiConfig } from "./onboard-custom-DGLlVcCk.js";
import { i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-DifXsFd-.js";
import { t as formatHealthCheckFailure } from "./health-format-FKtSoCB_.js";
import { n as promptRemoteGatewayConfig } from "./onboard-remote-D9jFUepF.js";
import { n as setupSkills } from "./onboard-skills-D95z_RGt.js";
...
async function removeChannelConfigWizard(cfg, runtime) {
	...
	while (true) {
		...
		if (configured.length === 0) {
			note$1(["No channel config found in openpaw.json.", `Tip: \`${formatCliCommand("openpaw channels status")}\` shows what is configured and enabled.`].join("\n"), "Remove channel");
			return next;
		}
...
async function promptGatewayConfig(cfg, runtime) {
	...
	if (authMode === "trusted-proxy") {
		note$1([
			"Trusted proxy mode: OpenPaw trusts user identity from a reverse proxy.",
			...
			"Docs: https://docs.openpaw.ai/gateway/trusted-proxy-auth"
		].join("\n"), "Trusted Proxy Auth");
...
async function runGatewayHealthCheck(params) {
	...
	await waitForGatewayReachable({
		...
		password: params.cfg.gateway?.auth?.password ?? process.env.OPENPAW_GATEWAY_PASSWORD,
		deadlineMs: 15e3
	});
	try {
		await healthCommand({
...
async function runConfigureWizard(opts, runtime = defaultRuntime) {
	try {
		...
		intro$1(opts.command === "update" ? "OpenPaw update wizard" : "OpenPaw configure");
		...
		if (snapshot.exists) {
			...
			if (!snapshot.valid) {
				outro$1(`Config invalid. Run \`${formatCliCommand("openpaw doctor")}\` to repair it, then re-run configure.`);
				runtime.exit(1);
				return;
			}
		}
		...
		let gatewayToken = nextConfig.gateway?.auth?.token ?? baseConfig.gateway?.auth?.token ?? process.env.OPENPAW_GATEWAY_TOKEN;
