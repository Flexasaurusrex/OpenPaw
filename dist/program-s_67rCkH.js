...
import { n as replaceCliName, r as resolveCliName } from "./command-format-Dzi36QGl.js";
...
import { n as resolveCliChannelOptions } from "./channel-options-BJKBiOwc.js";
import { t as getSubCliCommandsWithSubcommands } from "./register.subclis-Dqq4BCaj.js";
import { a as registerProgramCommands, r as getCoreCliCommandsWithSubcommands } from "./command-registry-EnmtT6c3.js";
import { r as setProgramContext } from "./program-context-Mcylp1PE.js";
import { t as forceFreePort } from "./ports-Qpr0A0Ju.js";
import "./tagline-DooArC9V.js";
import { n as formatCliBannerLine, r as hasEmittedCliBanner, t as emitCliBanner } from "./banner-C--rapzU.js";
...
function registerPreActionHooks(program, programVersion) {
	program.hook("preAction", async (_thisCommand, actionCommand) => {
		...
		const { ensureConfigReady } = await import("./config-guard-BAPc7xvd.js").then((n) => n.t);
		await ensureConfigReady({
			runtime: defaultRuntime,
			commandPath
		});
		if (PLUGIN_REQUIRED_COMMANDS.has(commandPath[0])) {
			const { ensurePluginRegistryLoaded } = await import("./plugin-registry-BmUwQfGk.js").then((n) => n.n);
