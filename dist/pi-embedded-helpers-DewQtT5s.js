import { n as resolveAgentConfig, u as resolveSessionAgentId } from "./agent-scope-9aJRv6zx.js";
import { i as resolveGatewayPort, t as STATE_DIR } from "./paths-Dn-gE1l8.js";
import { L as resolveUserPath, W as truncateUtf16Safe, ct as resolvePreferredOpenPawTmpDir, r as defaultRuntime, s as CHANNEL_IDS, t as createSubsystemLogger } from "./subsystem-DWLvTobT.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-BlAu1iW4.js";
import { _ as runExec, a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_USER_FILENAME, i as DEFAULT_HEARTBEAT_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-DlPWdeFR.js";
import { t as parseBooleanValue } from "./boolean-mcn6kL0s.js";
import { t as formatCliCommand } from "./command-format-x8oDHspF.js";
import { t as generateSecureToken } from "./secure-random-CXrBi7Jq.js";
import { c as SafeOpenError, i as getImageMetadata, l as openFileWithinRoot, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-B-YON1BR.js";
import { n as loadConfig, o as writeConfigFile, t as createConfigIO } from "./config-CMa41IiH.js";
import { A as DEFAULT_BROWSER_EVALUATE_ENABLED, D as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, E as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, M as DEFAULT_OPENPAW_BROWSER_ENABLED, N as DEFAULT_OPENPAW_BROWSER_PROFILE_NAME, O as DEFAULT_AI_SNAPSHOT_MAX_CHARS, S as stopChromeExtensionRelayServer, _ as fetchJson, a as resolveOpenPawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as appendCdpPath, h as withBrowserNavigationPolicy, i as launchOpenPawChrome, j as DEFAULT_OPENPAW_BROWSER_COLOR, k as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenPawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchOk, w as isLoopbackHost, x as ensureChromeExtensionRelayServer } from "./chrome-CYz0Uu7N.js";
import { t as SsrFBlockedError } from "./ssrf-DoQDLHSj.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-CoyY6qOv.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-DS1LEZcU.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-BHaeIGMJ.js";
import { R as canonicalizeMainSessionAlias, W as acquireSessionWriteLock, z as resolveAgentMainSessionKey } from "./sessions-CIs786H3.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-Dp92NXAm.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CgbqvzAO.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-CgbqvzAO.js")).closePlaywrightBrowserConnection();
		} catch {}
