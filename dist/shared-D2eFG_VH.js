import { M as toAgentModelListLike, n as listAgentIds } from "./agent-scope-DVw9WyO3.js";
import { s as normalizeAgentId } from "./session-key-Dx_ARweb.js";
import { Jt as DEFAULT_PROVIDER, g as resolveModelRefFromString, r as buildModelAliasIndex, s as modelKey } from "./model-selection-DLFgSmxJ.js";
...
function resolveKnownAgentId(params) {
	...
	if (!listAgentIds(params.cfg).includes(agentId)) throw new Error(`Unknown agent id "${raw}". Use "${formatCliCommand("openpaw agents list")}" to see configured agents.`);
	return agentId;
}
