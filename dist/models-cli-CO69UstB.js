...
import { St as loadProviderUsageSummary, Tt as resolveUsageProviderId, Yt as describeFailoverError, _r as DEFAULT_OAUTH_WARN_MS, gr as maskApiKey, l as runEmbeddedPiAgent, vr as buildAuthHealthSummary, wt as formatUsageWindowSummary, yr as formatRemainingShort } from "./reply-D_97LfkS.js";
...
import { C as parseDurationMs, i as loadConfig } from "./config-D2VtfSUL.js";
...
import { r as resolveForwardCompatModel } from "./model-B7b19Zdf.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./model-BIrY15-2.js";
...
import { f as openUrl } from "./onboard-helpers-C5liWlpx.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-D2eFG_VH.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-CTGUXwek.js";
import { n as logConfigUpdated } from "./logging-CZH6rk0L.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-_AAB4o7e.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-D2VtfSUL.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./model-selection-DLFgSmxJ.js").then((n) => n.ft);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-BIrY15-2.js");
