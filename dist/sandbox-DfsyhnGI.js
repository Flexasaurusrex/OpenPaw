import { r as STATE_DIR } from "./paths-5liSMgvV.js";
import { y as resolveUserPath } from "./utils-CLEQvfyB.js";
import { C as DEFAULT_USER_FILENAME, S as DEFAULT_TOOLS_FILENAME, _ as DEFAULT_HEARTBEAT_FILENAME, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, m as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_IDENTITY_FILENAME, w as ensureAgentWorkspace, x as DEFAULT_SOUL_FILENAME } from "./agent-scope-DVw9WyO3.js";
import { _ as CHANNEL_IDS, f as defaultRuntime, t as createSubsystemLogger } from "./subsystem-BlU6Lg5x.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-Dx_ARweb.js";
import { t as formatCliCommand } from "./command-format-BMHSLXMa.js";
import { i as loadConfig } from "./config-D2VtfSUL.js";
import { A as DEFAULT_OPENPAW_BROWSER_PROFILE_NAME, D as DEFAULT_BROWSER_EVALUATE_ENABLED, O as DEFAULT_OPENPAW_BROWSER_COLOR } from "./chrome-DXqMQMj3.js";
import { t as safeEqualSecret } from "./secret-equal-CQn9WoXt.js";
import { i as isLoopbackHost } from "./ws-DI10x-Zu.js";
import { a as resolveProfile, m as resolveBrowserControlAuth, p as ensureBrowserControlAuth, t as createBrowserRouteContext } from "./server-context-BR7ehuf9.js";
import { d as resolveSandboxInputPath, f as resolveSandboxPath, g as sanitizeEnvVars, o as syncSkillsToWorkspace } from "./skills-h9Q-iHsk.js";
import { t as registerBrowserRoutes } from "./routes-VSXeSaZa.js";
import { Q as acquireSessionWriteLock, U as canonicalizeMainSessionAlias, W as resolveAgentMainSessionKey } from "./sessions-DrdLhqGQ.js";
...
const DEFAULT_SANDBOX_COMMON_IMAGE = "openpaw-sandbox-common:bookworm-slim";
...
//#endregion
export { DEFAULT_SANDBOX_COMMON_IMAGE as A, resolveToolProfilePolicy as C, compileGlobPatterns as D, resolveCoreToolProfiles as E, SANDBOX_BROWSER_SECURITY_HASH_EPOCH as M, matchesAnyGlobPattern as O, normalizeToolName as S, listCoreToolSections as T, collectExplicitAllowlist as _, ensureSandboxWorkspaceForSession as a, stripPluginOnlyAllowlist as b, resolveSandboxRuntimeStatus as c, getBridgeAuthForPort as d, resolveSandboxConfigForAgent as f, buildPluginToolGroups as g, applyOwnerOnlyToolPolicy as h, removeSandboxContainer as i, DEFAULT_SANDBOX_IMAGE as j, DEFAULT_SANDBOX_BROWSER_IMAGE as k, execDockerRaw as l, resolveSandboxToolPolicyForAgent as m, listSandboxContainers as n, resolveSandboxContext as o, resolveSandboxScope as p, removeSandboxBrowserContainer as r, formatSandboxToolPolicyBlockedMessage as s, listSandboxBrowsers as t, getBlockedBindReason as u, expandPolicyWithPluginGroups as v, PROFILE_OPTIONS as w, expandToolGroups as x, mergeAlsoAllowPolicy as y };