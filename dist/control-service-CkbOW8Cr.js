...
import { x as ensureChromeExtensionRelayServer } from "./chrome-DXqMQMj3.js";
import { a as resolveProfile, i as resolveBrowserConfig, n as listKnownProfileNames, p as ensureBrowserControlAuth, t as createBrowserRouteContext } from "./server-context-BR7ehuf9.js";
...
async function stopKnownBrowserProfiles(params) {
	...
	try {
		...
		params.onWarn(`openpaw browser stop failed: ${String(err)}`);
	}
}
