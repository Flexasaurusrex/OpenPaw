...
import { i as pruneDiagnosticSessionStates, r as getDiagnosticSessionState, t as diagnosticSessionStates } from "./diagnostic-session-state-7Ra8u_hY.js";

//#region src/infra/diagnostic-events.ts
function getDiagnosticEventsState() {
	const globalStore = globalThis;
	if (!globalStore.__openpawDiagnosticEventsState) globalStore.__openpawDiagnosticEventsState = {
		seq: 0,
		listeners: /* @__PURE__ */ new Set(),
		dispatchDepth: 0
	};
	return globalStore.__openpawDiagnosticEventsState;
}
...
function startDiagnosticHeartbeat() {
	...
	heartbeatInterval = setInterval(() => {
		...
		import("./command-poll-backoff-DbSKAuyy.js").then((n) => n.t).then(({ pruneStaleCommandPolls }) => {
