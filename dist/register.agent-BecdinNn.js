...
import { B as theme, P as setVerbose, S as shortenHomePath, y as resolveUserPath } from "./utils-CLEQvfyB.js";
import "./thinking-EAliFiVK.js";
import { $t as parseIdentityMarkdown, Ht as createDefaultDeps, Mt as resolveSessionKeyForRequest, Zt as identityHasValues, jt as agentCommand } from "./reply-D_97LfkS.js";
import { i as resolveAgentDir, l as resolveAgentWorkspaceDir, n as listAgentIds, t as listAgentEntries, u as resolveDefaultAgentId, v as DEFAULT_IDENTITY_FILENAME } from "./agent-scope-DVw9WyO3.js";
import { f as defaultRuntime } from "./subsystem-BlU6Lg5x.js";
import { m as DEFAULT_ACCOUNT_ID, s as normalizeAgentId, t as DEFAULT_AGENT_ID } from "./session-key-Dx_ARweb.js";
import "./exec-DkdDR1S0.js";
import { Ft as resolveAuthStorePath, Mt as ensureAuthProfileStore } from "./model-selection-DLFgSmxJ.js";
...
import { h as GATEWAY_CLIENT_NAMES, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES } from "./message-channel-DlEv3rvX.js";
import "./send-Du6jbKSv.js";
import { i as loadConfig, l as writeConfigFile } from "./config-D2VtfSUL.js";
...
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-PixIvqwD.js";
...
import { c as resolveSessionTranscriptsDirForAgent } from "./paths-UwFQANoB.js";
...
import { a as randomIdempotencyKey, n as callGateway } from "./call-qMGOPQLT.js";
...
import { a as ensureWorkspaceAndSessions, l as moveToTrash } from "./onboard-helpers-C5liWlpx.js";
...
import { t as collectOption } from "./helpers-BQn43k0t.js";
...
import { r as setupChannels } from "./onboard-channels-D9ss7hvZ.js";
import { t as requireValidConfigSnapshot } from "./config-validation-DUb0Li8x.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, n as buildAgentSummaries, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-Dz7134Ax.js";
...
import { n as promptAuthChoiceGrouped } from "./auth-choice-prompt-Czeu1Jtv.js";
import { i as applyAuthChoice, r as warnIfModelConfigLooksOff } from "./auth-choice-CAhCq6sk.js";
...
async function agentViaGatewayCommand(opts, runtime) {
	...
	if (agentId) {
		if (!listAgentIds(cfg).includes(agentId)) throw new Error(`Unknown agent id "${agentIdRaw}". Use "${formatCliCommand("openpaw agents list")}" to see configured agents.`);
	}
...
async function agentsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	try {
		...
		} else await prompter.note(["Routing unchanged. Add bindings when you're ready.", "Docs: https://docs.openpaw.ai/concepts/multi-agent"].join("\n"), "Routing");
...
async function agentsListCommand(opts, runtime = defaultRuntime) {
	...
	lines.push(`Channel status reflects local config/creds. For live health: ${formatCliCommand("openpaw channels status --probe")}.`);
...
${formatHelpExamples([
		...
		["openpaw agent --session-id 1234 --message \"Summarize inbox\" --thinking medium", "Target a session with explicit thinking level."],
		["openpaw agent --to +15555550123 --message \"Trace logs\" --verbose on --json", "Enable verbose logging and JSON output."],
		["openpaw agent --to +15555550123 --message \"Summon reply\" --deliver", "Deliver reply."],
		["openpaw agent --agent ops --message \"Generate report\" --deliver --reply-channel slack --reply-to \"#reports\"", "Send reply to a different channel/target."]
	])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.openpaw.ai/cli/agent")}`).action(async (opts) => {
...
${formatHelpExamples([
		...
		["openpaw agents set-identity --workspace ~/.openpaw/workspace --from-identity", "Load from IDENTITY.md."],
		["openpaw agents set-identity --identity-file ~/.openpaw/workspace/IDENTITY.md --agent main", "Use a specific IDENTITY.md."]
	])}
`).action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
