...
import { i as isSecureWebSocketUrl } from "./net-BVkY67bp.js";
import { r as detectBinary } from "./onboard-helpers-CfGs7sWP.js";
import { n as resolveWideAreaDiscoveryDomain } from "./widearea-dns-Di4LBpuL.js";
...
async function promptRemoteGatewayConfig(cfg, prompter) {
	...
	if (!hasBonjourTool) await prompter.note(["Bonjour discovery requires dns-sd (macOS) or avahi-browse (Linux).", "Docs: https://docs.openpaw.ai/gateway/discovery"].join("\n"), "Discovery");
	if (wantsDiscover) {
