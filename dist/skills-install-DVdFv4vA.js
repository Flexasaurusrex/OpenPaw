import { c as ensureDir, g as resolveConfigDir, y as resolveUserPath } from "./utils-CLEQvfyB.js";
import { t as runCommandWithTimeout } from "./exec-DkdDR1S0.js";
import { d as hasBinary } from "./frontmatter-BAu7PLcH.js";
import { i as loadWorkspaceSkillEntries, t as resolveSkillsInstallPreferences, x as resolveSkillKey } from "./skills-h9Q-iHsk.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DLYr9x03.js";
import { t as resolveBrewExecutable } from "./brew-AuKrskR-.js";
import { t as isWithinDir } from "./path-safety-DGMaIf2C.js";
import { a as extractArchive$1, d as resolveArchiveOutputPath, f as stripArchivePath, p as validateArchiveEntryPath, r as safePathSegmentHashed, u as isWindowsDrivePath } from "./install-safe-path-DN73ttZx.js";
...
async function collectSkillInstallScanWarnings(entry) {
	...
	try {
		...
		} else if (summary.warn > 0) warnings.push(`Skill "${skillName}" has ${summary.warn} suspicious code pattern(s). Run "openpaw security audit --deep" for details.`);
	} catch (err) {
		warnings.push(`Skill "${skillName}" code safety scan failed (${String(err)}). Installation continues; run "openpaw security audit --deep" after install.`);
	}
	return warnings;
}
