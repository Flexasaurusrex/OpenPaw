...
const GOOGLE_LIVE_SINGLE_KEY = "OPENPAW_LIVE_GEMINI_KEY";
...
const PROVIDER_API_KEY_CONFIG = {
	anthropic: {
		liveSingle: "OPENPAW_LIVE_ANTHROPIC_KEY",
		listVar: "OPENPAW_LIVE_ANTHROPIC_KEYS",
	...
	openai: {
		liveSingle: "OPENPAW_LIVE_OPENAI_KEY",
...
function resolveProviderApiKeyConfig(provider) {
	...
	const liveSingle = custom?.liveSingle ?? `OPENPAW_LIVE_${base}_KEY`;
