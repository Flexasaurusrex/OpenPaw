import { c as resolveDefaultAgentId, m as resolveAgentModelPrimaryValue, s as resolveAgentWorkspaceDir } from "./agent-scope-CG5fO1-r.js";
import { c as expandHomePrefix, n as resolveConfigPath, r as resolveDefaultConfigCandidates, s as resolveStateDir, u as resolveRequiredHomeDir } from "./paths-C12iiEez.js";
import { A as isRecord, F as resolveConfigDir, G as isPlainObject$1, L as resolveUserPath, f as normalizeChatChannelId, s as CHANNEL_IDS } from "./subsystem-CrsB6DNT.js";
import { s as normalizeAgentId, t as DEFAULT_AGENT_ID } from "./session-key-BlAu1iW4.js";
import { $ as resolveShellEnvFallbackTimeoutMs, K as DEFAULT_CONTEXT_TOKENS, M as parseModelRef, Q as loadShellEnvFallback, et as shouldDeferShellEnvFallback, it as normalizeEnvVarKey, j as normalizeProviderId, nt as isDangerousHostEnvOverrideVarName, rt as isDangerousHostEnvVarName, tt as shouldEnableShellEnvFallback } from "./model-auth-BcCFChCF.js";
import { c as resolveMemorySlotDecision, l as isPathInside, o as normalizePluginsConfig, s as resolveEnableState, t as loadPluginManifestRegistry } from "./manifest-registry-B6UU1GUE.js";
...
//#endregion
export { splitShellArgs as $, parseConfigPath as A, analyzeShellCommand as B, isSupportedLocalAvatarExtension as C, setConfigOverride as D, resetConfigOverrides as E, normalizeTrustedSafeBinDirs as F, DEFAULT_SAFE_BINS as G, buildSafeShellCommand as H, SAFE_BIN_PROFILES as I, resolveCommandResolutionFromArgv as J, matchAllowlist as K, normalizeSafeBinProfileFixtures as L, unsetConfigValueAtPath as M, getTrustedSafeBinDirs as N, unsetConfigOverride as O, isTrustedSafeBinPath as P, unwrapKnownDispatchWrapperInvocation as Q, resolveSafeBinProfiles as R, isPathWithinRoot as S, getConfigOverrides as T, isWindowsPlatform as U, buildSafeBinsShellCommand as V, splitCommandChain as W, isDispatchWrapperExecutable as X, extractShellWrapperInlineCommand as Y, isShellWrapperExecutable as Z, normalizeScpRemoteHost as _, resolveConfigSnapshotHash as a, resolveTelegramPreviewStreamMode as at, isAvatarDataUrl as b, parseByteSize as c, VERSION as ct, resolveTelegramCustomCommands as d, isSafeExecutableValue as et, DEFAULT_IMESSAGE_ATTACHMENT_ROOTS as f, resolveIMessageRemoteAttachmentRoots as g, resolveIMessageAttachmentRoots as h, readConfigFileSnapshotForWrite as i, resolveSlackStreamingMode as it, setConfigValueAtPath as j, getConfigValueAtPath as k, TELEGRAM_COMMAND_NAME_PATTERN as l, resolveOwnerDisplaySetting as lt, mergeInboundPathRoots as m, loadConfig as n, resolveDiscordPreviewStreamMode as nt, writeConfigFile as o, DEFAULT_SUBAGENT_MAX_SPAWN_DEPTH as ot, isInboundPathAllowed as p, resolveAllowlistCandidatePath as q, readConfigFileSnapshot as r, resolveSlackNativeStreaming as rt, validateConfigObjectWithPlugins as s, resolveAgentMaxConcurrent as st, createConfigIO as t, mapStreamingModeToSlackLegacyDraftStreamMode as tt, normalizeTelegramCommandName as u, parseDurationMs as v, validateJsonSchemaValue as w, isAvatarHttpUrl as x, AVATAR_MAX_BYTES as y, validateSafeBinArgv as z };