...
import { B as theme, O as danger, P as setVerbose, z as isRich } from "./utils-CLEQvfyB.js";
import "./thinking-EAliFiVK.js";
import { Ht as createDefaultDeps, N as CHANNEL_MESSAGE_ACTION_NAMES, O as runMessageAction, ct as CHANNEL_TARGETS_DESCRIPTION, j as formatTargetDisplay, lt as CHANNEL_TARGET_DESCRIPTION, zt as createOutboundSendDeps } from "./reply-D_97LfkS.js";
import "./agent-scope-DVw9WyO3.js";
import { T as normalizeChatChannelId, f as defaultRuntime, x as getChatChannelMeta } from "./subsystem-BlU6Lg5x.js";
...
import { C as runGlobalGatewayStopSafely } from "./deliver-CSiAkuBe.js";
...
import { t as ensurePluginRegistryLoaded } from "./plugin-registry-Dd1JRo2u.js";
...
${formatHelpExamples([
		...
		["openpaw message send --target +15555550123 --message \"Hi\" --media photo.jpg", "Send a message with media."],
		["openpaw message poll --channel discord --target channel:123 --poll-question \"Snack?\" --poll-option Pizza --poll-option Sushi", "Create a Discord poll."],
		["openpaw message react --channel discord --target 123 --message-id 456 --emoji \"✅\"", "React to a message."]
	])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.openpaw.ai/cli/message")}`).action(() => {
