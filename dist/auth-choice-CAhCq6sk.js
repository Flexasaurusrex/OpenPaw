...
import { M as toAgentModelListLike, O as resolveDefaultAgentWorkspaceDir, i as resolveAgentDir, l as resolveAgentWorkspaceDir, u as resolveDefaultAgentId } from "./agent-scope-DVw9WyO3.js";
import { At as upsertAuthProfile, B as SYNTHETIC_DEFAULT_MODEL_REF, Ct as generateChutesPkce, Dt as listProfilesForProvider, K as getCustomProviderApiKey, Lt as resolveOpenPawAgentDir, Mt as ensureAuthProfileStore, N as VENICE_DEFAULT_MODEL_REF, St as exchangeChutesCodeForTokens, X as resolveEnvApiKey, ct as isHuggingfacePolicyLocked, lt as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, m as resolveDefaultModelForAgent, pt as resolveAuthProfileOrder, st as discoverHuggingfaceModels, wt as parseOAuthCallbackInput, xt as CHUTES_AUTHORIZE_ENDPOINT } from "./model-selection-DLFgSmxJ.js";
...
import { a as detectZaiEndpoint, c as ensureModelAllowlistEntry, i as upsertSharedEnvVar, n as applyOpenAIConfig, o as GOOGLE_GEMINI_DEFAULT_MODEL, r as applyOpenAIProviderConfig, s as applyGoogleGeminiModelDefault, t as OPENAI_DEFAULT_MODEL } from "./openai-model-default-DvH9P62U.js";
import { c as OPENAI_CODEX_DEFAULT_MODEL, l as applyOpenAICodexModelDefault, r as applyPrimaryModel, s as promptAndConfigureVllm } from "./model-picker-Dpm45Jn1.js";
...
async function applyAuthChoicePluginProvider(params, options) {
	...
	const agentDir = params.agentDir ?? (agentId === defaultAgentId ? resolveOpenPawAgentDir() : resolveAgentDir(nextConfig, agentId));
...
async function loginOpenAICodexOAuth(params) {
	...
	try {
		...
		await prompter.note("Trouble with OAuth? See https://docs.openpaw.ai/start/faq", "OAuth help");
		throw err;
	}
}
