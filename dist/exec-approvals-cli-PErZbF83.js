...
import { B as theme, z as isRich } from "./utils-CLEQvfyB.js";
...
import { c as readExecApprovalsSnapshot, p as saveExecApprovals } from "./exec-approvals-FygPo23-.js";
import { n as callGatewayFromCli } from "./gateway-rpc-DIhkFdRa.js";
import "./systemd-DwAFBjTQ.js";
import "./service-C4VX1Mu3.js";
import { t as renderTable } from "./table-BgQdk22X.js";
import { t as describeUnknownError } from "./shared-bPqS0PI0.js";
import { i as resolveNodeId, r as nodesCallOpts } from "./rpc-DluYLbTl.js";
...
function registerExecApprovalsCli(program) {
	...
	const allowlist = approvals.command("allowlist").description("Edit the per-agent allowlist").addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatExample("openpaw approvals allowlist add \"~/Projects/**/bin/rg\"", "Allowlist a local binary pattern for the main agent.")}\n${formatExample("openpaw approvals allowlist add --agent main --node <id|name|ip> \"/usr/bin/uptime\"", "Allowlist on a specific node/agent.")}\n${formatExample("openpaw approvals allowlist add --agent \"*\" \"/usr/bin/uname\"", "Allowlist for all agents (wildcard).")}\n${formatExample("openpaw approvals allowlist remove \"~/Projects/**/bin/rg\"", "Remove an allowlist pattern.")}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/approvals", "docs.openpaw.ai/cli/approvals")}\n`);
