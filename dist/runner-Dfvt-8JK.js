import { E as runExec, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue } from "./agent-scope-DDpD-TG0.js";
import { J as logVerbose, Z as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-8Ku6x7B-.js";
import { E as resolveApiKeyForProvider, T as requireApiKey, X as resolveOpenPawAgentDir, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-CyxgoZl2.js";
import { t as normalizeChatType } from "./chat-type-CH3W-zKy.js";
import { _ as kindFromMime, d as detectMime, h as isAudioFileName, p as getFileExtension } from "./image-ops-B46KQegA.js";
import { f as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, h as resolveIMessageAttachmentRoots, m as mergeInboundPathRoots, n as loadConfig, p as isInboundPathAllowed } from "./config-3ZvLrn4o.js";
import { t as describeImageWithModel, w as ensureOpenPawModelsJson } from "./image-BTETHlGM.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-Csnddqcc.js";
import { n as fetchWithTimeout } from "./fetch-timeout-CGFENWmz.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-C6irlKf3.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-S5nxWrcs.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-DRe38nk1.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenPawAgentDir());
