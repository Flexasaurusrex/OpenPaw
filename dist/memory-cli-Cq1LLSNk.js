...
import { C as parseDurationMs, i as loadConfig, ut as splitShellArgs } from "./config-DcMGW7oZ.js";
...
import { f as listMemoryFiles, p as normalizeExtraMemoryPaths } from "./query-expansion-6kMx1ddq.js";
...
import { n as withProgress, r as withProgressTotals } from "./progress-C3lmnWTa.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-xiNGfZoz.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-BKGTL4jm.js").then((n) => n.t);
