...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE } from "./onboard-helpers-CQbFd_nK.js";
import { t as WizardCancelledError } from "./prompts-AgMVBh2-.js";
import { t as createClackPrompter } from "./clack-prompter-Y1t9o76v.js";
import { t as assertSupportedRuntime } from "./runtime-guard-BwjfOUlQ.js";
...
import { n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-CO6Wbics.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-CgREHlQh.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-CJuhGtPz.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-DzkeCoMc.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-DA_eW4Hy.js").then((n) => n.i);
