...
import { Ct as resolveApiKeyForProvider, R as normalizeProviderId, St as requireApiKey, nt as normalizeGoogleModelId } from "./auth-profiles-Cob1PkNk.js";
import { A as resolveAgentModelFallbackValues, j as resolveAgentModelPrimaryValue } from "./agent-scope-Ch2id45o.js";
import { n as runExec } from "./exec-G9-WTRVN.js";
import { _ as isInboundPathAllowed, g as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, v as mergeInboundPathRoots, y as resolveIMessageAttachmentRoots } from "./config-DUiZpzJa.js";
import { t as normalizeChatType } from "./chat-type-DCCseuxJ.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-CD21cBoz.js";
import { r as formatUncaughtError, t as extractErrorCode } from "./errors-CAg9uklP.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-ClarSsef.js";
import { n as fetchWithTimeout } from "./fetch-timeout-Cw7FDyqK.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-s1EvTHMo.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DAZSahJ7.js";
import { t as describeImageWithModel } from "./image-C9blTh14.js";
import { n as loadModelCatalog, r as modelSupportsVision, t as findModelInCatalog } from "./model-catalog-ZJIgO4tD.js";
...
function isUnhandledRejectionHandled(reason) {
	for (const handler of handlers) try {
		...
		console.error("[openpaw] Unhandled rejection handler failed:", err instanceof Error ? err.stack ?? err.message : err);
	}
	return false;
}
function installUnhandledRejectionHandler() {
	process$1.on("unhandledRejection", (reason, _promise) => {
		...
		if (isTransientNetworkError(reason)) {
			console.warn("[openpaw] Non-fatal unhandled rejection (continuing):", formatUncaughtError(reason));
			return;
		}
...
async function runCliEntry(params) {
	...
	const outputDir = await fs$1.mkdtemp(path.join(os.tmpdir(), "openpaw-media-cli-"));
