...
import { C as sleep, S as shortenHomePath, t as CONFIG_DIR, x as shortenHomeInString, y as resolveUserPath } from "./utils-CLEQvfyB.js";
import { h as DEFAULT_AGENT_WORKSPACE_DIR, j as resolveAgentModelPrimaryValue, w as ensureAgentWorkspace } from "./agent-scope-DVw9WyO3.js";
...
import { D as isAvatarImageDataUrl, E as isAvatarHttpUrl, j as looksLikeAvatarPath, pt as isSafeExecutableValue } from "./config-BrzzL48f.js";
import { t as VERSION } from "./version-CmTNPgEd.js";
import { n as pickPrimaryTailnetIPv4 } from "./tailnet-CfnDL3PT.js";
import { l as pickPrimaryLanIPv4, s as isValidIPv4 } from "./ws-DI10x-Zu.js";
import { c as resolveSessionTranscriptsDirForAgent } from "./paths-UwFQANoB.js";
import { n as callGateway } from "./call-DHXpVMRJ.js";
import { t as isWSL } from "./wsl-BCmcMXD3.js";
import { r as stylePromptTitle } from "./prompt-style-DE_Wto62.js";
...
async function printWizardHeader(runtime) {
	const { VERSION } = await import("./version-CmTNPgEd.js").then((n) => n.r);
	const { resolveCommitHash } = await import("./git-commit-BSxVcncN.js").then((n) => n.t);
	const { pickTagline } = await import("./tagline-C8yJwrvu.js").then((n) => n.n);
	const header = [
		"",
		`🐾 OpenPaw ${VERSION} (${(resolveCommitHash() || "unknown").slice(0, 7)}) — ${pickTagline()}`,
		"",
		"       /\\_/\\                                              /\\_/\\       ",
		"      ( o.o )                                            ( ^.^ )      ",
		"       > ^ <                                              > ^ <       ",
