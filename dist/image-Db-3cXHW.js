...
import { N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue } from "./agent-scope-DDpD-TG0.js";
import { A as isRecord, z as shortenHomeInString } from "./subsystem-8Ku6x7B-.js";
import { C as getApiKeyForModel, T as requireApiKey, X as resolveOpenPawAgentDir, _ as normalizeProviders, b as resolveImplicitProviders, et as normalizeSecretInput, v as resolveImplicitBedrockProvider, y as resolveImplicitCopilotProvider } from "./model-selection-CyxgoZl2.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-j5tVLINv.js";
import { N as sanitizeUserFacingText } from "./pi-embedded-helpers-B6X3gzAY.js";
import { n as loadConfig } from "./config-3ZvLrn4o.js";
import { n as redactToolDetail } from "./redact-DuvewBuc.js";
...
async function ensureOpenPawModelsJson(config, agentDirOverride) {
...
function summarizeKnownExec(words) {
	...
	if (bin === "openpaw") {
		...
		return sub ? `run openpaw ${sub}` : "run openpaw";
	}
