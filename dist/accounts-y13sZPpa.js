import { a as resolveOAuthDir } from "./paths-Dn-gE1l8.js";
import { L as resolveUserPath, M as jidToE164, Q as success, q as info, r as defaultRuntime, rt as getChildLogger } from "./subsystem-DWLvTobT.js";
import { f as DEFAULT_ACCOUNT_ID, p as normalizeAccountId } from "./session-key-BlAu1iW4.js";
...
async function pickWebChannel(pref, authDir = resolveDefaultWebAuthDir()) {
	...
	if (!await webAuthExists(authDir)) throw new Error(`No WhatsApp Web session found. Run \`${formatCliCommand("openpaw channels login --channel whatsapp --verbose")}\` to link.`);
	return choice;
}
