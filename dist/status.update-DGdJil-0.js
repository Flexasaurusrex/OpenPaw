...
import { n as checkUpdateStatus, r as compareSemverStrings } from "./channel-account-context-CdAUhcqS.js";
...
function formatUpdateAvailableHint(update) {
	...
	return `Update available${details.length > 0 ? ` (${details.join(" · ")})` : ""}. Run: ${formatCliCommand("openpaw update")}`;
}
