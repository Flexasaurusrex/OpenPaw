...
import { E as resolveOpenPawAgentDir } from "./auth-profiles-Cob1PkNk.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-B5QvbIt5.js").then((n) => n.n)).ensurePiAuthJsonFromAuthProfiles(resolveOpenPawAgentDir());
