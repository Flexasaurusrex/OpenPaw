...
import { Ht as normalizeSecretInput } from "./model-selection-DLFgSmxJ.js";
import { t as formatCliCommand } from "./command-format-BMHSLXMa.js";
import { _ as resolveNodeManagerOptions, r as detectBinary } from "./onboard-helpers-C5liWlpx.js";
...
async function setupSkills(cfg, workspaceDir, runtime, prompter) {
	...
	if (installable.length > 0) {
		...
		for (const name of selected) {
			...
			runtime.log(`Tip: run \`${formatCliCommand("openpaw doctor")}\` to review skills + requirements.`);
