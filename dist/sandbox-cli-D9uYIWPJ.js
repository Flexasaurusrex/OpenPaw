...
import { B as theme, R as colorize, z as isRich } from "./utils-CLEQvfyB.js";
import { r as resolveAgentConfig } from "./agent-scope-DVw9WyO3.js";
import { C as normalizeAnyChannelId, f as defaultRuntime } from "./subsystem-BlU6Lg5x.js";
import { C as parseAgentSessionKey, c as normalizeMainKey, l as resolveAgentIdFromSessionKey, r as buildAgentMainSessionKey, s as normalizeAgentId } from "./session-key-Dx_ARweb.js";
...
import { t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-DlEv3rvX.js";
...
import { f as resolveSandboxConfigForAgent, i as removeSandboxContainer, m as resolveSandboxToolPolicyForAgent, n as listSandboxContainers, r as removeSandboxBrowserContainer, t as listSandboxBrowsers } from "./sandbox-DfsyhnGI.js";
...
import { K as resolveMainSessionKey, W as resolveAgentMainSessionKey, s as loadSessionStore } from "./sessions-DrdLhqGQ.js";
...
import { t as formatDurationCompact } from "./format-duration-DYW43xu5.js";
...
function displaySummary(containers, browsers, runtime) {
	...
	if (mismatchCount > 0) {
		...
		runtime.log(`   Run '${formatCliCommand("openpaw sandbox recreate --all")}' to update all containers.`);
	}
}
