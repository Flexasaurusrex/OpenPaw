...
import { h as DEFAULT_AGENT_WORKSPACE_DIR, j as resolveAgentModelPrimaryValue, w as ensureAgentWorkspace } from "./agent-scope-Ch2id45o.js";
import { t as runCommandWithTimeout } from "./exec-G9-WTRVN.js";
import { D as isAvatarImageDataUrl, E as isAvatarHttpUrl, j as looksLikeAvatarPath, pt as isSafeExecutableValue } from "./config-DUiZpzJa.js";
...
import { c as pickPrimaryLanIPv4, o as isValidIPv4 } from "./net-BVkY67bp.js";
...
import { r as stylePromptTitle } from "./prompt-style-DmTpv6Qh.js";
...
async function printWizardHeader(runtime) {
	const { VERSION } = await import("./version-C26Rk39r.js").then((n) => n.r);
	const { resolveCommitHash } = await import("./git-commit-EV8KJ5xc.js").then((n) => n.t);
	const { pickTagline } = await import("./tagline-DooArC9V.js").then((n) => n.n);
	const header = [
		"",
