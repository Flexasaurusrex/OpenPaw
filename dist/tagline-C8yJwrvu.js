...
const TAGLINES = [
	...
	"I'll butter your workflow like a cat roll: messy, delicious, effective.",
...
function pickTagline(options = {}) {
	const override = (options.env ?? process.env)?.OPENPAW_TAGLINE_INDEX;
	if (override !== void 0) {
...
//#endregion
export { tagline_exports as n, pickTagline as t };