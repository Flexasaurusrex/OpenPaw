import { F as shouldLogVerbose, L as warn, O as danger, k as info } from "./utils-CLEQvfyB.js";
import { f as defaultRuntime } from "./subsystem-BlU6Lg5x.js";
import { i as logDebug, t as runCommandWithTimeout } from "./exec-DkdDR1S0.js";
import { t as formatCliCommand } from "./command-format-BMHSLXMa.js";
import { a as isErrno } from "./errors-DZpIsD32.js";
...
async function handlePortError(err, port, context, runtime = defaultRuntime) {
	if (err instanceof PortInUseError || isErrno(err) && err.code === "EADDRINUSE") {
		...
		if (details) {
			...
			if (/openpaw|src\/index\.ts|dist\/index\.js/.test(details)) runtime.error(warn("It looks like another OpenPaw instance is already running. Stop it or pick a different port."));
		}
