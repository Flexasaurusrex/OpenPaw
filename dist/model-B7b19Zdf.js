import { Kt as DEFAULT_CONTEXT_TOKENS, Lt as resolveOpenPawAgentDir, l as normalizeProviderId } from "./model-selection-DLFgSmxJ.js";
...
function normalizeModelCompat(model) {
	...
	if (!isZai && !isMoonshot || !isOpenAiCompletionsModel(model)) return model;
...
* a hint.
*
* See: https://github.com/openpaw/openpaw/issues/17328
*/
const LOCAL_PROVIDER_HINTS = {
	ollama: "Ollama requires authentication to be registered as a provider. Set OLLAMA_API_KEY=\"ollama-local\" (any value works) or run \"openpaw configure\". See: https://docs.openpaw.ai/providers/ollama",
	vllm: "vLLM requires authentication to be registered as a provider. Set VLLM_API_KEY (any value works) or run \"openpaw configure\". See: https://docs.openpaw.ai/providers/vllm"
};
