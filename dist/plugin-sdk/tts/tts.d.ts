...
export declare function resolveTtsConfig(cfg: OpenPawConfig): ResolvedTtsConfig;
...
export declare function buildTtsSystemPromptHint(cfg: OpenPawConfig): string | undefined;
