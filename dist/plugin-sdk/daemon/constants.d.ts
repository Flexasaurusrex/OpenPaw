export declare const GATEWAY_LAUNCH_AGENT_LABEL = "ai.openpaw.gateway";
export declare const GATEWAY_SYSTEMD_SERVICE_NAME = "openpaw-gateway";
export declare const GATEWAY_WINDOWS_TASK_NAME = "OpenPaw Gateway";
export declare const GATEWAY_SERVICE_MARKER = "openpaw";
export declare const GATEWAY_SERVICE_KIND = "gateway";
export declare const NODE_LAUNCH_AGENT_LABEL = "ai.openpaw.node";
export declare const NODE_SYSTEMD_SERVICE_NAME = "openpaw-node";
export declare const NODE_WINDOWS_TASK_NAME = "OpenPaw Node";
export declare const NODE_SERVICE_MARKER = "openpaw";
