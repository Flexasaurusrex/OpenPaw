...
import type { OpenPawConfig, ConfigFileSnapshot } from "./types.js";
...
export declare function createConfigIO(overrides?: ConfigIoDeps): {
    ...
    writeConfigFile: (cfg: OpenPawConfig, options?: ConfigWriteOptions) => Promise<void>;
};
export declare function clearConfigCache(): void;
export declare function loadConfig(): OpenPawConfig;
...
export declare function writeConfigFile(cfg: OpenPawConfig, options?: ConfigWriteOptions): Promise<void>;
