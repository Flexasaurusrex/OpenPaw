...
export declare function resolveAgentMaxConcurrent(cfg?: OpenPawConfig): number;
export declare function resolveSubagentMaxConcurrent(cfg?: OpenPawConfig): number;
