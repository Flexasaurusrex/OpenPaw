...
export type OpenPawPluginToolFactory = (ctx: OpenPawPluginToolContext) => AnyAgentTool | AnyAgentTool[] | null | undefined;
...
export type OpenPawPluginHttpHandler = (req: IncomingMessage, res: ServerResponse) => Promise<boolean> | boolean;
export type OpenPawPluginHttpRouteHandler = (req: IncomingMessage, res: ServerResponse) => Promise<void> | void;
...
export type OpenPawPluginModule = OpenPawPluginDefinition | ((api: OpenPawPluginApi) => void | Promise<void>);
export type OpenPawPluginApi = {
    ...
    logger: PluginLogger;
    registerTool: (tool: AnyAgentTool | OpenPawPluginToolFactory, opts?: OpenPawPluginToolOptions) => void;
    registerHook: (events: string | string[], handler: InternalHookHandler, opts?: OpenPawPluginHookOptions) => void;
    ...
    registerCli: (registrar: OpenPawPluginCliRegistrar, opts?: {
        commands?: string[];
    }) => void;
