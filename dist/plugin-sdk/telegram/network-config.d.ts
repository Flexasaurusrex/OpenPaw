...
export declare const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV = "OPENPAW_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export declare const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "OPENPAW_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export declare const TELEGRAM_DNS_RESULT_ORDER_ENV = "OPENPAW_TELEGRAM_DNS_RESULT_ORDER";
