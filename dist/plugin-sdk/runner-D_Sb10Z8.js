...
import { Z as logVerbose, et as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-ClBbMbTX.js";
import { C as resolveIMessageAttachmentRoots, S as mergeInboundPathRoots, b as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, n as loadConfig, x as isInboundPathAllowed } from "./config-CHEq4Abk.js";
import { E as resolveApiKeyForProvider, H as resolveOpenPawAgentDir, T as requireApiKey, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-CCe5uWRJ.js";
import { E as runExec, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue } from "./agent-scope-CvD9EBI7.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-BrbVKM5f.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-HTNZ5_-9.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-B4efmqzH.js";
import { t as normalizeChatType } from "./chat-type-CfYBRycO.js";
import { C as ensureOpenPawModelsJson, t as describeImageWithModel } from "./image-B7Pp2ZXp.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-C_YHAV2y.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-BGJiQLNQ.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenPawAgentDir());
