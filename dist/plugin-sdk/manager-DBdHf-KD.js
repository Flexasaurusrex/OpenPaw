...
import { s as resolveStateDir } from "./paths-CImrry1O.js";
import { B as resolveUserPath, O as clampInt, k as clampNumber, q as truncateUtf16Safe, t as createSubsystemLogger } from "./subsystem-DAkun_KF.js";
import { n as retryAsync } from "./retry-CJnEYOU0.js";
import { r as isTruthyEnvValue } from "./command-format-B6MNxjoy.js";
import { E as resolveApiKeyForProvider, T as requireApiKey } from "./model-selection-v8gO7VON.js";
import { n as resolveAgentConfig, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-SDywqdsf.js";
import { n as formatErrorMessage } from "./errors-CF5PYiCs.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-CmDEBxhd.js";
import { c as resolveSessionTranscriptsDirForAgent } from "./paths-pMWC5YrF.js";
...
function formatLocalSetupError(err) {
	...
	return [
		...
		missing ? "2) Reinstall OpenPaw (this should install node-llama-cpp): npm i -g openpaw@latest" : null,
...
var MemoryManagerSyncOps = class {
	...
	async runSync(params) {
		...
		try {
			if (needsFullReindex) {
				if (process.env.OPENPAW_TEST_FAST === "1" && process.env.OPENPAW_TEST_MEMORY_UNSAFE_REINDEX === "1") await this.runUnsafeReindex({
