...
import { C as resolveIMessageAttachmentRoots, S as mergeInboundPathRoots, b as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, n as loadConfig, x as isInboundPathAllowed } from "./config--rmKT1sM.js";
import { E as resolveApiKeyForProvider, H as resolveOpenPawAgentDir, T as requireApiKey, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-v8gO7VON.js";
...
import { C as ensureOpenPawModelsJson, t as describeImageWithModel } from "./image-BtQFf0dp.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-C1B0U7Fh.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-CyNz8LA0.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenPawAgentDir());
