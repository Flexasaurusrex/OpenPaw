...
export declare function summarizeExistingConfig(config: OpenPawConfig): string;
...
export declare function printWizardHeader(runtime: RuntimeEnv): Promise<void>;
export declare function applyWizardMetadata(cfg: OpenPawConfig, params: {
    command: string;
    mode: OnboardMode;
}): OpenPawConfig;
