export declare const DEFAULT_OPENPAW_BROWSER_ENABLED = true;
export declare const DEFAULT_BROWSER_EVALUATE_ENABLED = true;
export declare const DEFAULT_OPENPAW_BROWSER_COLOR = "#FF4500";
export declare const DEFAULT_OPENPAW_BROWSER_PROFILE_NAME = "openpaw";
