...
export declare function buildMentionRegexes(cfg: OpenPawConfig | undefined, agentId?: string): RegExp[];
...
export declare function stripMentions(text: string, ctx: MsgContext, cfg: OpenPawConfig | undefined, agentId?: string): string;
