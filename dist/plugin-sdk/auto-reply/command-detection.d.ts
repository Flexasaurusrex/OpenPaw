...
export declare function hasControlCommand(text?: string, cfg?: OpenPawConfig, options?: CommandNormalizeOptions): boolean;
export declare function isControlCommandMessage(text?: string, cfg?: OpenPawConfig, options?: CommandNormalizeOptions): boolean;
/**
...
export declare function shouldComputeCommandAuthorized(text?: string, cfg?: OpenPawConfig, options?: CommandNormalizeOptions): boolean;
