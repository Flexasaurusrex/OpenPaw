...
import { c as logoutWeb, r as resolveWhatsAppAccount } from "./accounts-CDfuhPF9.js";
import { X as info, Y as danger, i as defaultRuntime, tt as success } from "./subsystem-ClBbMbTX.js";
import { n as loadConfig } from "./config-CHEq4Abk.js";
import { t as formatCliCommand } from "./command-format-D2Cctd5h.js";
import { A as logInfo } from "./agent-scope-CvD9EBI7.js";
import { i as waitForWaConnection, n as formatError, t as createWaSocket } from "./session-o5pDY94L.js";
...
async function loginWeb(verbose, waitForConnection, runtime = defaultRuntime, accountId) {
	...
	try {
		...
		if (code === DisconnectReason.loggedOut) {
			...
			console.error(danger(`WhatsApp reported the session is logged out. Cleared cached web session; please rerun ${formatCliCommand("openpaw channels login")} and scan the QR again.`));
