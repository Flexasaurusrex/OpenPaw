import { E as runExec } from "./agent-scope-CvD9EBI7.js";
...
function prefersSips() {
	return process.env.OPENPAW_IMAGE_BACKEND === "sips" || process.env.OPENPAW_IMAGE_BACKEND !== "sharp" && isBun() && process.platform === "darwin";
}
...
async function withTempDir(fn) {
	const dir = await fs$1.mkdtemp(path.join(os.tmpdir(), "openpaw-img-"));
	try {
		return await fn(dir);
	} finally {
		await fs$1.rm(dir, {
