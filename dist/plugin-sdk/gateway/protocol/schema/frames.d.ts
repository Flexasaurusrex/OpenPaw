...
export declare const ConnectParamsSchema: import("@sinclair/typebox").TObject<{
    ...
    client: import("@sinclair/typebox").TObject<{
        id: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"cli" | "test" | "webchat" | "webchat-ui" | "openpaw-control-ui" | "gateway-client" | "openpaw-macos" | "openpaw-ios" | "openpaw-android" | "node-host" | "fingerprint" | "openpaw-probe">[]>;
