export declare const GATEWAY_CLIENT_IDS: {
    ...
    readonly CONTROL_UI: "openpaw-control-ui";
    readonly WEBCHAT: "webchat";
    readonly CLI: "cli";
    readonly GATEWAY_CLIENT: "gateway-client";
    readonly MACOS_APP: "openpaw-macos";
    readonly IOS_APP: "openpaw-ios";
    readonly ANDROID_APP: "openpaw-android";
    readonly NODE_HOST: "node-host";
    readonly TEST: "test";
    readonly FINGERPRINT: "fingerprint";
    readonly PROBE: "openpaw-probe";
};
