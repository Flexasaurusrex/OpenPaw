...
export declare function listAgentsForGateway(cfg: OpenPawConfig): {
    defaultId: string;
    mainKey: string;
    scope: SessionScope;
...
export declare function canonicalizeSpawnedByForAgent(cfg: OpenPawConfig, agentId: string, spawnedBy?: string): string | undefined;
...
export declare function loadCombinedSessionStoreForGateway(cfg: OpenPawConfig): {
    storePath: string;
    store: Record<string, SessionEntry>;
};
export declare function getSessionDefaults(cfg: OpenPawConfig): GatewaySessionsDefaults;
export declare function resolveSessionModelRef(cfg: OpenPawConfig, entry?: SessionEntry | Pick<SessionEntry, "model" | "modelProvider" | "modelOverride" | "providerOverride">, agentId?: string): {
    provider: string;
    model: string;
};
