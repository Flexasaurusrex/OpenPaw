...
export declare function resolveBootstrapMaxChars(cfg?: OpenPawConfig): number;
export declare function resolveBootstrapTotalMaxChars(cfg?: OpenPawConfig): number;
