...
import { n as loadConfig, o as writeConfigFile, t as createConfigIO } from "./config--rmKT1sM.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-HIXOtcyl.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-HIXOtcyl.js")).closePlaywrightBrowserConnection();
		} catch {}
