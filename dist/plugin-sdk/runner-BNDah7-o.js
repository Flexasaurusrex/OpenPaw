...
import { Z as logVerbose, et as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-DAkun_KF.js";
import { C as resolveIMessageAttachmentRoots, S as mergeInboundPathRoots, b as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, n as loadConfig, x as isInboundPathAllowed } from "./config-CwTZzzhp.js";
import { E as resolveApiKeyForProvider, H as resolveOpenPawAgentDir, T as requireApiKey, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-CLx-pfYR.js";
import { E as runExec, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue } from "./agent-scope-SDywqdsf.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-DqsnXTrX.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-CmDEBxhd.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-BtxMj3Uk.js";
import { t as normalizeChatType } from "./chat-type-CfYBRycO.js";
import { C as ensureOpenPawModelsJson, t as describeImageWithModel } from "./image-B3AVIWiA.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-Bi2QlmEB.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-4Pt57drO.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenPawAgentDir());
