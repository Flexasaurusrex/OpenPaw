...
import { i as resolveGatewayPort, t as STATE_DIR } from "./paths-CImrry1O.js";
import { B as resolveUserPath, c as CHANNEL_IDS, ft as resolvePreferredOpenPawTmpDir, i as defaultRuntime, q as truncateUtf16Safe, t as createSubsystemLogger } from "./subsystem-ClBbMbTX.js";
import { n as loadConfig, o as writeConfigFile, t as createConfigIO } from "./config-CHEq4Abk.js";
import { i as parseBooleanValue, t as formatCliCommand } from "./command-format-D2Cctd5h.js";
import { E as runExec, _ as DEFAULT_SOUL_FILENAME, b as ensureAgentWorkspace, f as DEFAULT_AGENTS_FILENAME, g as DEFAULT_IDENTITY_FILENAME, h as DEFAULT_HEARTBEAT_FILENAME, m as DEFAULT_BOOTSTRAP_FILENAME, n as resolveAgentConfig, p as DEFAULT_AGENT_WORKSPACE_DIR, u as resolveSessionAgentId, v as DEFAULT_TOOLS_FILENAME, y as DEFAULT_USER_FILENAME } from "./agent-scope-CvD9EBI7.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-DBPj4TD8.js";
import { b as openFileWithinRoot, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, y as SafeOpenError } from "./image-ops-BrbVKM5f.js";
import { t as SsrFBlockedError } from "./ssrf-DswcqIq6.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-BY77wqMn.js";
import { a as syncSkillsToWorkspace, h as safeEqualSecret, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-B-OtTxpA.js";
import { A as DEFAULT_OPENPAW_BROWSER_PROFILE_NAME, C as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, D as DEFAULT_BROWSER_EVALUATE_ENABLED, E as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, O as DEFAULT_OPENPAW_BROWSER_COLOR, S as stopChromeExtensionRelayServer, T as DEFAULT_AI_SNAPSHOT_MAX_CHARS, _ as fetchJson, a as resolveOpenPawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as appendCdpPath, h as withBrowserNavigationPolicy, i as launchOpenPawChrome, j as isLoopbackHost, k as DEFAULT_OPENPAW_BROWSER_ENABLED, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenPawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchOk, w as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, x as ensureChromeExtensionRelayServer } from "./chrome-BjvadydC.js";
import { A as acquireSessionWriteLock, B as canonicalizeMainSessionAlias, V as resolveAgentMainSessionKey } from "./sessions-Dxbm56T1.js";
import { i as saveMediaBuffer, t as ensureMediaDir } from "./store-DPo6CKL5.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-45ohyAD0.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-45ohyAD0.js")).closePlaywrightBrowserConnection();
		} catch {}
