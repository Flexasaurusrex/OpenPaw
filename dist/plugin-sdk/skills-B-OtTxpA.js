import { B as resolveUserPath, E as CONFIG_DIR, t as createSubsystemLogger } from "./subsystem-ClBbMbTX.js";
import { i as parseBooleanValue } from "./command-format-D2Cctd5h.js";
import { it as isDangerousHostEnvVarName } from "./model-selection-CCe5uWRJ.js";
import { M as normalizeSkillFilter, w as resolveOpenPawPackageRootSync } from "./agent-scope-CvD9EBI7.js";
import { a as LEGACY_MANIFEST_KEYS, c as normalizePluginsConfig, l as resolveEnableState, o as MANIFEST_KEY, t as loadPluginManifestRegistry, u as resolveMemorySlotDecision } from "./manifest-registry-CR0scqab.js";
...
function resolveOpenPawManifestBlock(params) {
...
function resolveOpenPawManifestRequires(metadataObj) {
...
function resolveOpenPawManifestInstall(metadataObj, parseInstallSpec) {
	return (Array.isArray(metadataObj.install) ? metadataObj.install : []).map((entry) => parseInstallSpec(entry)).filter((entry) => Boolean(entry));
}
function resolveOpenPawManifestOs(metadataObj) {
	return normalizeStringList(metadataObj.os);
}
function parseOpenPawManifestInstallBase(input, allowedKinds) {
