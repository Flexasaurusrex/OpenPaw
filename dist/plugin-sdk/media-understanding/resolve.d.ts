...
export declare function resolveCapabilityConfig(cfg: OpenPawConfig, capability: MediaUnderstandingCapability): MediaUnderstandingConfig | undefined;
...
export declare function resolveConcurrency(cfg: OpenPawConfig): number;
