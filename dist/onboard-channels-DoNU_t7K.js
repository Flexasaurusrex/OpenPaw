...
import { _t as createPluginLoaderLogger, vt as loadOpenPawPlugins } from "./reply-C7c1Otq4.js";
import { l as resolveAgentWorkspaceDir, u as resolveDefaultAgentId } from "./agent-scope-DVw9WyO3.js";
import { S as listChatChannels, b as formatChannelSelectionLine, t as createSubsystemLogger, y as formatChannelPrimerLine } from "./subsystem-BlU6Lg5x.js";
...
import { n as isChannelConfigured } from "./plugin-auto-enable-CpQKk2Ow.js";
import { t as enablePluginInConfig } from "./enable-DICma8Dz.js";
import { n as recordPluginInstall, r as installPluginFromNpmSpec, t as buildNpmResolutionInstallFields } from "./installs-YBEdbqLX.js";
...
async function noteChannelPrimer(prompter, channels) {
	...
	await prompter.note([
		...
		"Multi-user DMs: run: " + formatCliCommand("openpaw config set session.dmScope \"per-channel-peer\"") + " (or \"per-account-channel-peer\" for multi-account channels) to isolate sessions.",
