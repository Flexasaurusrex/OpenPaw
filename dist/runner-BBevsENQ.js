...
import { E as resolveApiKeyForProvider, T as requireApiKey, X as resolveOpenPawAgentDir, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-D5TmXO_y.js";
...
import { f as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, h as resolveIMessageAttachmentRoots, m as mergeInboundPathRoots, n as loadConfig, p as isInboundPathAllowed } from "./config-jCs8Cwk2.js";
import { t as describeImageWithModel, w as ensureOpenPawModelsJson } from "./image-CYYlJ0aE.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-DCfYNd5y.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-B4B9P3NN.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenPawAgentDir());
