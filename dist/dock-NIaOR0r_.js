import { l as escapeRegExp, m as normalizeE164 } from "./utils-CLEQvfyB.js";
import { D as requireActivePluginRegistry, v as CHAT_CHANNEL_ORDER, x as getChatChannelMeta } from "./subsystem-BlU6Lg5x.js";
import { h as normalizeAccountId } from "./session-key-Dx_ARweb.js";
import { f as resolveSlackAccount, o as normalizeWhatsAppTarget, p as resolveSlackReplyToMode, u as resolveTelegramAccount, v as resolveDiscordAccount } from "./plugins-PixIvqwD.js";
import { n as resolveWhatsAppAccount } from "./accounts-DQouuDyL.js";
import { t as resolveIMessageAccount } from "./accounts-Cx7B1Aw-.js";
import { n as resolveSignalAccount } from "./accounts-B5K1ARxi.js";
...
function warnLegacyToolsBySenderKey(rawKey) {
	...
	process.emitWarning(`toolsBySender key "${trimmed}" is deprecated. Use explicit prefixes (id:, e164:, username:, name:). Legacy unprefixed keys are matched as id only.`, {
		...
		code: "OPENPAW_TOOLS_BY_SENDER_UNTYPED_KEY"
	});
}
