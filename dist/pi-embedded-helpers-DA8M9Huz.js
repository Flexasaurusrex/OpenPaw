...
import { B as resolveAgentMainSessionKey, G as acquireSessionWriteLock, z as canonicalizeMainSessionAlias } from "./sessions-D8Bl20ZC.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CvzpcE9X.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-CvzpcE9X.js")).closePlaywrightBrowserConnection();
		} catch {}
