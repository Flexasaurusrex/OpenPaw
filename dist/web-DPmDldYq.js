...
import { a as buildGroupHistoryKey, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey, s as normalizeAgentId } from "./session-key-RFNBcO1g.js";
...
import { a as resolveChannelGroupRequireMention, i as resolveChannelGroupPolicy } from "./dock-CIQZSu0X.js";
...
import { B as resolveDefaultGroupPolicy, Bn as formatInboundEnvelope, C as sleepWithAbort, F as buildPairingReply, H as warnMissingProviderGroupPolicyFallbackOnce, I as resolveMentionGating, Jn as normalizeMentionText, L as DEFAULT_GROUP_HISTORY_LIMIT, R as buildHistoryContextFromEntries, Rn as createInboundDebouncer, S as computeBackoff, U as shouldAckReactionForWhatsApp, Un as hasControlCommand, V as resolveOpenProviderRuntimeGroupPolicy, Vn as resolveEnvelopeFormatOptions, W as dispatchReplyWithBufferedBlockDispatcher, Wn as shouldComputeCommandAuthorized, X as getReplyFromConfig, Y as createDedupeCache, nn as normalizeGroupActivation, qn as buildMentionRegexes, rn as parseActivationCommand, wn as enqueueSystemEvent, z as recordPendingHistoryEntryIfEnabled, zn as resolveInboundDebounceMs } from "./subagent-registry-C3IVJ9fO.js";
import { W as resolveGroupSessionKey, c as readSessionUpdatedAt, d as updateLastRoute, l as recordSessionMetaFromInbound, s as loadSessionStore } from "./sessions-BOuQLul1.js";
import "./tokens-ZjGx7ut4.js";
import "./plugins-BOsODpl9.js";
import { a as logWebSelfId, c as pickWebChannel, i as getWebAuthAgeMs, m as webAuthExists, n as resolveWhatsAppAccount, r as WA_WEB_AUTH_DIR, u as readWebSelfId } from "./accounts-ZciIdins.js";
...
import { J as formatLocationText, Y as toLocationContext } from "./send-BPN9CyRt.js";
...
import { r as saveMediaBuffer } from "./store-8cGa4yTM.js";
...
import { c as resolveIdentityNamePrefix, l as resolveMessagePrefix, t as createReplyPrefixOptions } from "./reply-prefix-BR6w-klU.js";
...
import { c as resolveChunkMode, i as chunkMarkdownTextWithMode, l as resolveTextChunkLimit } from "./chunk-CSy6-pZ0.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-Dja2scho.js";
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-DAZSahJ7.js";
import { a as loadWebMedia } from "./ir-Bmjg7yjJ.js";
...
import { t as finalizeInboundContext } from "./inbound-context-DyFg5U4O.js";
...
import { i as readChannelAllowFromStore, s as upsertChannelPairingRequest } from "./pairing-store-BjCCgKtE.js";
...
import { n as recordChannelActivity } from "./channel-activity-DVjNqtU-.js";
import { t as convertMarkdownTables } from "./tables-D2EB277q.js";
...
import { n as resolveAgentRoute, t as buildAgentSessionKey } from "./resolve-route-ASm3WzJn.js";
...
import { r as setActiveWebListener } from "./active-listener-CjPVVXSZ.js";
import "./pi-tools.policy-CScfFv2x.js";
import { i as markdownToWhatsApp, n as sendMessageWhatsApp, r as sendReactionWhatsApp } from "./outbound-BrtS2p6w.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-TmYgQsPf.js";
import { t as loginWeb } from "./login-CosqMAw2.js";
...
async function processMessage(params) {
	...
	const responsePrefix = prefixOptions.responsePrefix ?? (configuredResponsePrefix === void 0 && isSelfChat ? resolveIdentityNamePrefix(params.cfg, params.route.agentId) ?? "[openpaw]" : void 0);
...
async function monitorWebChannel(verbose, listenerFactory = monitorWebInbox, keepAlive = true, replyResolver = getReplyFromConfig, runtime = defaultRuntime, abortSignal, tuning = {}) {
	...
	while (true) {
		...
		if (loggedOut) {
			runtime.error(`WhatsApp session logged out. Run \`${formatCliCommand("openpaw channels login --channel web")}\` to relink.`);
			await closeListener();
			break;
		}
		reconnectAttempts += 1;
