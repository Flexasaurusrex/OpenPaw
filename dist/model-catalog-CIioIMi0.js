...
import { E as resolveOpenPawAgentDir } from "./auth-profiles-F3rq6gIp.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-DLmh5LD-.js").then((n) => n.n)).ensurePiAuthJsonFromAuthProfiles(resolveOpenPawAgentDir());
