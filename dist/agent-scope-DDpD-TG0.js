import { s as resolveStateDir, u as resolveRequiredHomeDir } from "./paths-C0uiCw4Q.js";
import { $ as warn, K as danger, L as resolveUserPath, P as pathExists, Y as logVerboseConsole, Z as shouldLogVerbose, it as getLogger, q as info, r as defaultRuntime, t as createSubsystemLogger } from "./subsystem-8Ku6x7B-.js";
import { b as parseAgentSessionKey, s as normalizeAgentId, t as DEFAULT_AGENT_ID, v as isCronSessionKey, y as isSubagentSessionKey } from "./session-key-BlAu1iW4.js";
...
//#endregion
//#region src/infra/openpaw-root.ts
...
async function resolveOpenPawPackageRoot(opts) {
...
function resolveOpenPawPackageRootSync(opts) {
	for (const candidate of buildCandidates(opts)) {
...
const WORKSPACE_STATE_DIRNAME = ".openpaw";
