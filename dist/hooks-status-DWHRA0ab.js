...
import { n as isConfigPathTruthy, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-BLa0Bzoq.js";
...
function normalizeInstallOptions(entry) {
	...
	return install.map((spec, index) => {
		...
		if (!label) if (spec.kind === "bundled") label = "Bundled with OpenPaw";
