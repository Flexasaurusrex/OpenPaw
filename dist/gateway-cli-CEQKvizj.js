...
import { d as hasBinary } from "./frontmatter-C-mnS1Ag.js";
import { r as isPathInsideWithRealpath } from "./scan-paths-CLl8bFYK.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-DhLwpMz_.js";
import { l as isTestDefaultMemorySlotDisabled } from "./manifest-registry-DqqQzpz1.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-ITwt8ZlC.js";
import { C as parseDurationMs, Ct as resolveAgentMaxConcurrent, D as isAvatarImageDataUrl, E as isAvatarHttpUrl, a as parseConfigJson5, c as resolveConfigSnapshotHash, d as OpenPawSchema, dt as applyMergePatch, ft as applyLegacyMigrations, i as loadConfig, j as looksLikeAvatarPath, l as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, r as createConfigIO, s as readConfigFileSnapshotForWrite, u as validateConfigObjectWithPlugins, w as AVATAR_MAX_BYTES, wt as resolveSubagentMaxConcurrent } from "./config-DcMGW7oZ.js";
import { n as resolveRuntimeServiceVersion, t as VERSION } from "./version-C26Rk39r.js";
import "./env-vars-DiCRNmoj.js";
import "./dock-CIQZSu0X.js";
import { $ as validateNodePairRejectParams, $t as verifyDeviceSignature, A as validateCronStatusParams, At as PROTOCOL_VERSION, B as validateExecApprovalsGetParams, Bt as rejectDevicePairing, C as validateConfigSetParams, Ct as validateWakeParams, D as validateCronRemoveParams, Dt as validateWizardNextParams, E as validateCronListParams, Et as validateWizardCancelParams, F as validateDevicePairRemoveParams, Ft as buildDeviceAuthPayload, G as validateModelsListParams, Gt as summarizeDeviceTokens, H as validateExecApprovalsNodeSetParams, Ht as requestDevicePairing, I as validateDeviceTokenRevokeParams, It as approveDevicePairing, J as validateNodeInvokeParams, Jt as roleScopesAllow, K as validateNodeDescribeParams, Kt as updatePairedDeviceMetadata, L as validateDeviceTokenRotateParams, Lt as ensureDeviceToken, M as validateDevicePairApproveParams, Mt as errorShape, N as validateDevicePairListParams, O as validateCronRunParams, Ot as validateWizardStartParams, P as validateDevicePairRejectParams, Pt as parseSessionLabel, Q as validateNodePairListParams, Qt as normalizeDevicePublicKeyBase64Url, R as validateExecApprovalRequestParams, Rt as getPairedDevice, S as validateConfigSchemaParams, St as validateUpdateRunParams, T as validateCronAddParams, Tt as validateWebLoginWaitParams, U as validateExecApprovalsSetParams, Ut as revokeDeviceToken, V as validateExecApprovalsNodeGetParams, Vt as removePairedDevice, W as validateLogsTailParams, Wt as rotateDeviceToken, X as validateNodeListParams, Xt as deriveDeviceIdFromPublicKey, Y as validateNodeInvokeResultParams, Z as validateNodePairApproveParams, _ as validateChatInjectParams, _t as validateSkillsStatusParams, a as validateAgentWaitParams, at as validateRequestFrame, b as validateConfigGetParams, bt as validateTalkModeParams, c as validateAgentsFilesGetParams, ct as validateSessionsDeleteParams, d as validateAgentsListParams, dt as validateSessionsPreviewParams, et as validateNodePairRequestParams, f as validateAgentsUpdateParams, ft as validateSessionsResetParams, g as validateChatHistoryParams, gt as validateSkillsInstallParams, h as validateChatAbortParams, ht as validateSkillsBinsParams, i as validateAgentParams, it as validatePushTestParams, j as validateCronUpdateParams, jt as ErrorCodes, k as validateCronRunsParams, kt as validateWizardStatusParams, l as validateAgentsFilesListParams, lt as validateSessionsListParams, m as validateChannelsStatusParams, mt as validateSessionsUsageParams, n as formatValidationErrors, nt as validateNodeRenameParams, o as validateAgentsCreateParams, ot as validateSendParams, p as validateChannelsLogoutParams, pt as validateSessionsResolveParams, q as validateNodeEventParams, qt as verifyDeviceToken, r as validateAgentIdentityParams, rt as validatePollParams, s as validateAgentsDeleteParams, st as validateSessionsCompactParams, tt as validateNodePairVerifyParams, u as validateAgentsFilesSetParams, ut as validateSessionsPatchParams, v as validateChatSendParams, vt as validateSkillsUpdateParams, w as validateConnectParams, wt as validateWebLoginStartParams, x as validateConfigPatchParams, xt as validateToolsCatalogParams, y as validateConfigApplyParams, yt as validateTalkConfigParams, z as validateExecApprovalResolveParams, zt as listDevicePairing } from "./client-DYR6lezz.js";
import { f as loadGatewayTlsRuntime$1, l as authorizeOperatorScopesForMethod, n as callGateway, s as ADMIN_SCOPE$3, u as isNodeRoleMethod } from "./call-BVtRsC6W.js";
import { _ as normalizeGatewayClientMode, f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-C8ZvZtXL.js";
import { c as readJsonFile, l as writeJsonAtomic, s as createAsyncLock } from "./pairing-token-Cs6U982f.js";
import { t as safeEqualSecret } from "./secret-equal-CDUVxXmp.js";
import { a as isTrustedProxyAddress, c as pickPrimaryLanIPv4, d as resolveGatewayListenHosts, f as resolveHostName, l as resolveClientIp, n as isLoopbackAddress, o as isValidIPv4, p as rawDataToString, r as isLoopbackHost, s as normalizeHostHeader, t as isLocalishHost, u as resolveGatewayBindHost } from "./net-BVkY67bp.js";
import "./ip-BkPdUc6e.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-CBDDP2ef.js";
import { i as normalizeInputProvenance } from "./input-provenance-B7NUmWCh.js";
import { $ as resolveCronStyleNow, $n as resolveTtsApiKey, $t as setGatewaySigusr1RestartPolicy, A as createOutboundSendDeps$1, An as DEFAULT_INPUT_MAX_REDIRECTS, At as normalizeOptionalAgentId, C as sleepWithAbort, Cn as parseVerboseOverride, Cr as getAgentRunContext, Ct as summarizeRestartSentinel, D as resolveAgentOutboundTarget, Dt as normalizeCronJobCreate, E as resolveAgentDeliveryPlan, Et as normalizeHttpWebhookUrl, Fn as resolveInputFileLimits, Ft as migrateLegacyCronPayload, Gn as isAbortTrigger, Gt as applyBrowserProxyPaths, Hn as formatZonedTimestamp, Ht as detectSuspiciousPatterns, It as buildDeliveryFromLegacyPayload, J as getTotalPendingReplies, Jt as deferGatewayRestartUntilIdle, K as dispatchInboundMessage, Kn as stopSubagentsForRequester, Kt as persistBrowserProxyFiles, Ln as resolveAgentTimeoutMs, Lt as hasLegacyDeliveryHints, Mn as extractFileContentFromSource, Mt as normalizeOptionalText, Nn as extractImageContentFromSource, Nt as normalizePayloadToSystemText, O as createOutboundSendDeps, On as DEFAULT_INPUT_IMAGE_MAX_BYTES, Ot as normalizeCronJobPatch, Pn as normalizeMimeList, Pt as normalizeRequiredName, Qn as isTtsProviderConfigured, Qt as scheduleGatewaySigusr1Restart, R as buildHistoryContextFromEntries, Rt as stripLegacyDeliveryFields, S as computeBackoff, Sn as applyVerboseOverride, Sr as emitAgentEvent, Tn as isSystemEventContextChanged, Tr as registerAgentRunContext, Tt as writeRestartSentinel, Ut as getHookType, Vt as buildSafeExternalPrompt, Wt as isExternalHookSession, Xn as getTtsProvider, Xt as isGatewaySigusr1RestartExternallyAllowed, Yn as resolveUserTimezone, Yt as emitGatewayRestart, Z as BARE_SESSION_RESET_PROMPT, Zn as isTtsEnabled, Zt as markGatewaySigusr1RestartHandled, _ as loadOpenPawPlugins, _t as runWithModelFallback, a as runSubagentAnnounceFlow, ar as setTtsProvider, at as readLatestAssistantReply, b as readJsonBodyWithLimit, br as stripHeartbeatToken, bt as formatDoctorNonInteractiveHint, c as abortEmbeddedPiRun, cr as OPENAI_TTS_VOICES, ct as ensureOutboundSessionEntry, d as applyToolPolicyPipeline, dn as requestHeartbeatNow, dr as getTotalQueueSize, en as setPreRestartDeferralCheck, er as resolveTtsAutoMode, et as getCliSessionId, f as buildDefaultToolPolicyPipelineSteps, fr as resetAllLanes, ft as resolveOutboundTarget, gn as resolveSessionAuthProfileOverride, gr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, h as resolvePluginTools, hn as resolveSendPolicy, hr as CommandLane, ht as resetDirectoryCache, in as loadProviderUsageSummary, ir as setTtsEnabled, it as createOpenPawTools, j as resolveAgentAvatar, jn as DEFAULT_INPUT_TIMEOUT_MS, jt as normalizeOptionalSessionKey, k as createDefaultDeps, kn as DEFAULT_INPUT_IMAGE_MIMES, kt as inferLegacyName, l as getActiveEmbeddedRunCount, lr as getActiveTaskCount, lt as resolveOutboundSessionRoute, m as getPluginToolMeta, mn as normalizeSendPolicy, mr as waitForActiveTasks, n as initSubagentRegistry, nn as normalizeGroupActivation, nr as resolveTtsPrefsPath, nt as runCliAgent, o as clearSessionQueues, or as textToSpeech, ot as resolveAnnounceTargetFromKey, pr as setCommandLaneConcurrency, pt as resolveSessionDeliveryTarget, q as createReplyDispatcher, qt as consumeGatewaySigusr1RestartAuthorization, r as listDescendantRunsForRequester, rr as resolveTtsProviderOrder, s as runEmbeddedPiAgent, sr as OPENAI_TTS_MODELS, t as countActiveDescendantRuns, tn as unbindThreadBindingsBySessionKey, tr as resolveTtsConfig, tt as setCliSessionId, u as waitForEmbeddedPiRunEnd, w as agentCommand, wn as enqueueSystemEvent, wr as onAgentEvent, x as requestBodyErrorToText, xn as applyModelOverrideToSessionEntry, xr as clearAgentRunContext, xt as formatRestartSentinelMessage, y as handleSlackHttpRequest, yt as consumeRestartSentinel } from "./subagent-registry-CxSu1VdQ.js";
import { B as resolveMainSessionKeyFromConfig, C as stripEnvelopeFromMessage, D as stripInlineDirectiveTagsFromMessageForDisplay, E as stripInlineDirectiveTagsForDisplay, H as snapshotSessionOrigin, I as canonicalizeMainSessionAlias, J as deliveryContextFromSession, K as cleanStaleLockFiles, L as resolveAgentMainSessionKey, Q as normalizeSessionDeliveryFields, R as resolveExplicitAgentSessionKey, S as resolveSessionTranscriptCandidates, X as mergeDeliveryContext, _ as archiveSessionTranscripts, b as readSessionPreviewItemsFromTranscript, f as updateSessionStore, g as archiveFileOnDisk, j as resolveSessionResetPolicy, k as evaluateSessionFreshness, n as extractDeliveryInfo, r as parseSessionThreadInfo, s as loadSessionStore, v as capArrayByJsonBytes, w as stripEnvelopeFromMessages, y as readSessionMessages, z as resolveMainSessionKey } from "./sessions-DHAFOBA0.js";
import { i as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-ZjGx7ut4.js";
import { n as listChannelPlugins, o as normalizeWhatsAppTarget, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-BOsODpl9.js";
import { n as resolveWhatsAppAccount } from "./accounts-ZciIdins.js";
import { t as buildChannelAccountBindings } from "./bindings-CqMiIKM5.js";
import "./logging-CGlH1P7F.js";
import "./send-B3kZHiOq.js";
import "./send-CUkZT9uJ.js";
import { n as createBrowserRouteDispatcher, r as getMachineDisplayName } from "./with-timeout-CSlHvjbK.js";
import { C as runGlobalGatewayStopSafely, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads, x as getGlobalHookRunner } from "./deliver-C6XlXNEG.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, m as isDiagnosticsEnabled } from "./diagnostic-dNzRjagQ.js";
import "./diagnostic-session-state-BPGgn8hZ.js";
import "./accounts-CxmFIdzG.js";
import { d as loadCronStore, f as resolveCronStorePath, p as saveCronStore } from "./send-DCHOQxuf.js";
import { c as detectMime } from "./image-ops-CD21cBoz.js";
import "./pi-embedded-helpers-0uRstZmW.js";
import { C as resolveToolProfilePolicy, E as resolveCoreToolProfiles, T as listCoreToolSections, _ as collectExplicitAllowlist, w as PROFILE_OPTIONS, y as mergeAlsoAllowPolicy } from "./sandbox-lLs3oxDJ.js";
import "./chrome-DAZEL2P9.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-QhdHV80-.js";
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-LAV7Qr_D.js";
import { g as mergeGatewayTailscaleConfig, h as ensureGatewayStartupAuth } from "./server-context-Vp197Jfw.js";
import "./routes-Cue3T4Lw.js";
import "./redact-8ygXzN2c.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-CAg9uklP.js";
import { n as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-VAZ-b1a1.js";
import "./paths-DZnnOi0n.js";
import { t as SsrFBlockedError } from "./ssrf-B0PMs-Z1.js";
import "./store-8cGa4yTM.js";
import { a as formatPortDiagnostics, n as inspectPortUsage, t as ensurePortAvailable } from "./ports-Dpij79Ry.js";
import { t as movePathToTrash } from "./trash-BKArGMlZ.js";
import "./accounts-JARp6uPy.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-DXBvtSww.js";
...
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-BR6w-klU.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-Cq1LLSNk.js";
import { n as resolveMemorySearchConfig } from "./manager-BKGTL4jm.js";
import "./gemini-auth-DsOU4McY.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-s1EvTHMo.js";
import "./query-expansion-6kMx1ddq.js";
import "./retry-BLB59C0N.js";
import { a as ToolInputError } from "./target-errors-DnsFD3hl.js";
...
import { r as isRestartEnabled } from "./commands-LMwKegSD.js";
import "./commands-registry-DHdKdxYt.js";
import "./image-DPkJaepE.js";
import "./tool-display-qnmuGsrD.js";
import { d as registerUnhandledRejectionHandler } from "./runner-BJLKxoNh.js";
import { n as loadModelCatalog } from "./model-catalog-CIioIMi0.js";
...
import { S as registerSkillsChangeListener, _ as requestNodePairing, c as recordRemoteNodeInfo, d as removeRemoteNodeInfo, f as setSkillsRemoteRegistry, g as renamePairedNode, h as rejectNodePairing, l as refreshRemoteBinsForConnectedNodes, m as listNodePairing, o as getRemoteSkillEligibility, p as approveNodePairing, s as primeRemoteSkillsCache, u as refreshRemoteNodeBins, v as updatePairedNodeMetadata, x as getSkillsSnapshotVersion, y as verifyNodeToken } from "./skill-commands-CAW-2yVH.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-XahlOvQp.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-Dktke6OC.js";
import "./fetch-CjnkV4k0.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-CUBR7Atl.js";
import "./nodes-screen-CNrWLRSw.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-Dn_xGzv4.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-CqPW0P6k.js";
import { t as getChannelActivity } from "./channel-activity-DVjNqtU-.js";
import { n as normalizePollInput } from "./polls-CGpoOVqd.js";
import "./tables-D2EB277q.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-Bwh1V-uQ.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-CacBBbof.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-BjRDmc1c.js";
...
import { n as withProgress } from "./progress-C3lmnWTa.js";
import "./replies-Byg5EBY-.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-CfGs7sWP.js";
import "./prompt-style-DmTpv6Qh.js";
import "./pairing-labels-CNVGG8qu.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-B1slmWSE.js";
...
import { t as ensureOpenPawCliOnPath } from "./path-env-DrJBjg0l.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-DPoOXTVi.js";
import { n as inheritOptionFromParent } from "./command-options-DMZnoQOj.js";
import { t as buildChannelUiCatalog } from "./catalog-CoNACL-i.js";
import { t as WizardCancelledError } from "./prompts-AgMVBh2-.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-21splUMz.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-DcTBxiHL.js";
...
import "./channels-status-issues-BxYfv32c.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-D3f5BMdk.js";
...
import "./lifecycle-core-BelnJC3W.js";
import "./systemd-hints-AFJZxLqX.js";
import { t as parsePort$1 } from "./parse-port-BeoMTegh.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-B6rjiDIA.js";
import "./diagnostics-B-pUkS7e.js";
import "./table-B_HA_dFd.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-Di4LBpuL.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-D9ZJm_Ey.js";
import { c as resolveNodeCommandAllowlist, l as probeGateway, n as collectEnabledInsecureOrDangerousFlags, s as isNodeCommandAllowed } from "./audit-D3BWzWQD.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-e9chsQPw.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-BFob3w8a.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-BH4BC-3J.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-C5TGR09L.js";
import { h as normalizeUpdateChannel, l as DEFAULT_PACKAGE_CHANNEL, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-CdAUhcqS.js";
import { t as runOnboardingWizard } from "./onboarding-BZaZfNjb.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-BIYnndyO.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-D6x7Fiq-.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CkPxknZj.js";
import "./dm-policy-shared-DN01dwcn.js";
import "./node-service-Dzkw1AGK.js";
import "./status.update-DGdJil-0.js";
import { t as resolveSystemRunCommand } from "./system-run-command-Sqp7RaFe.js";
import { t as installSkill } from "./skills-install-21W-MPps.js";
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-Dcna2CtA.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-DoGNb5P5.js";
import { n as forceFreePortAndWait } from "./ports-Qpr0A0Ju.js";
...
async function runAutoUpdateCommand(params) {
	...
	if (argv.length === 0) argv.push("openpaw", ...baseArgs);
	try {
		const res = await runCommandWithTimeout(argv, {
			timeoutMs: params.timeoutMs,
			env: { OPENPAW_AUTO_UPDATE: "1" }
		});
		return {
			ok: res.code === 0,
			code: res.code,
...
async function runGatewayUpdateCheck(params) {
	...
	if (cmp != null && cmp < 0) {
		...
		if (shouldRunUpdateHints && shouldNotify) {
			params.log.info(`update available (${tag}): v${resolved.version} (current v${VERSION}). Run: ${formatCliCommand("openpaw update")}`);
...
function spawnGogServe(cfg) {
	...
	child.on("exit", (code, signal) => {
		...
		if (addressInUse) {
			log$3.warn("gog serve failed to bind (address already in use); stopping restarts. Another watcher is likely running. Set OPENPAW_SKIP_GMAIL_WATCHER=1 or stop the other process.");
			watcherProcess = null;
			return;
		}
...
async function runCronIsolatedAgentTurn(params) {
	...
	const failDeliveryTarget = (error) => withRunSession({
		status: "error",
		error,
	...
	if (deliveryRequested && !skipHeartbeatDelivery && !skipMessagingToolDelivery) {
		if (resolvedDelivery.error) {
			if (!deliveryBestEffort) return failDeliveryTarget(resolvedDelivery.error.message);
		...
		const failOrWarnMissingDeliveryField = (message) => {
			if (!deliveryBestEffort) return failDeliveryTarget(message);
...
async function readCronRunLogEntriesPage(filePath, opts) {
	...
	const filtered = parseAllRunLogEntries(raw, { jobId: opts?.jobId }).filter((entry) => {
		...
		if (deliveryStatuses) {
			...
			if (!deliveryStatuses.includes(deliveryStatus)) return false;
		}
...
async function readCronRunLogEntriesPageAll(opts) {
	...
	const filtered = (await Promise.all(jsonlFiles.map(async (filePath) => {
...
function isDisabledByEnv$1() {
	if (isTruthyEnvValue(process.env.OPENPAW_DISABLE_BONJOUR)) return true;
...
async function startGatewayBonjourAdvertiser(opts) {
	...
	const hostname = (process.env.OPENPAW_MDNS_HOSTNAME?.trim() || process.env.PAWBOT_MDNS_HOSTNAME?.trim() || "openpaw").replace(/\.local$/i, "").split(".")[0].trim() || "openpaw";
	const instanceName = typeof opts.instanceName === "string" && opts.instanceName.trim() ? opts.instanceName.trim() : `${hostname} (OpenPaw)`;
...
function formatBonjourInstanceName(displayName) {
	...
	if (!trimmed) return "OpenPaw";
	if (/openpaw/i.test(trimmed)) return trimmed;
	return `${trimmed} (OpenPaw)`;
}
function resolveBonjourCliPath(opts = {}) {
	const envPath = (opts.env ?? process.env).OPENPAW_CLI_PATH?.trim();
...
async function resolveTailnetDnsHint(opts) {
	const envRaw = (opts?.env ?? process.env).OPENPAW_TAILNET_DNS?.trim();
...
async function startGatewayDiscovery(params) {
	...
	const bonjourEnabled = mdnsMode !== "off" && process.env.OPENPAW_DISABLE_BONJOUR !== "1" && !process.env.VITEST;
	...
	const sshPortEnv = mdnsMinimal ? void 0 : process.env.OPENPAW_SSH_PORT?.trim();
...
*
* @see https://github.com/pawbot/pawbot/issues/3658
*/
...
function buildBaseConfigSchema() {
	...
	const hints = applyDerivedTags(mapSensitivePaths(OpenPawSchema, "", buildBaseHints()));
	const next = {
...
async function maybeSendNodeWakeNudge(nodeId) {
	...
	try {
		const result = await sendApnsAlert({
			...
			registration,
			nodeId,
			title: "OpenPaw needs a quick reopen",
			body: "Tap to reopen OpenPaw and restore the node connection."
		});
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BqpbkiCW.js");
...
const pushHandlers = { "push.test": async ({ params, respond }) => {
	...
	const title = normalizeOptionalString(params.title) ?? "OpenPaw";
...
const updateHandlers = { "update.run": async ({ params, respond, client, context }) => {
	...
	try {
		...
		result = await runGatewayUpdate({
			timeoutMs,
			cwd: await resolveOpenPawPackageRoot({
				moduleUrl: import.meta.url,
				argv1: process.argv[1],
				cwd: process.cwd()
			}) ?? process.cwd(),
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-Dn_xGzv4.js").then((n) => n.a);
...
function extractHookToken(req) {
	...
	const headerToken = typeof req.headers["x-openpaw-token"] === "string" ? req.headers["x-openpaw-token"].trim() : "";
...
async function startBrowserControlServerIfEnabled() {
	if (isTruthyEnvValue(process.env.OPENPAW_SKIP_BROWSER_CONTROL_SERVER)) return null;
	const override = process.env.OPENPAW_BROWSER_CONTROL_MODULE?.trim();
	const mod = override ? await import(override) : await import("./control-service-Bwh1V-uQ.js").then((n) => n.t);
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			...
			await startGmailWatcherWithLogs({
				cfg: nextConfig,
				log: params.logHooks,
				onSkipped: () => params.logHooks.info("skipping gmail watcher restart (OPENPAW_SKIP_GMAIL_WATCHER=1)")
			});
		}
		if (plan.restartChannels.size > 0) if (isTruthyEnvValue(process.env.OPENPAW_SKIP_CHANNELS) || isTruthyEnvValue(process.env.OPENPAW_SKIP_PROVIDERS)) params.logChannels.info("skipping channel reload (OPENPAW_SKIP_CHANNELS=1 or OPENPAW_SKIP_PROVIDERS=1)");
		else {
...
async function resolveGatewayRuntimeConfig(params) {
	...
	const canvasHostEnabled = process.env.OPENPAW_SKIP_CANVAS_HOST !== "1" && params.cfg.canvasHost?.enabled !== false;
	const trustedProxies = params.cfg.gateway?.trustedProxies ?? [];
	assertGatewayAuthConfigured(resolvedAuth);
	if (tailscaleMode === "funnel" && authMode !== "password") throw new Error("tailscale funnel requires gateway auth mode=password (set gateway.auth.password or OPENPAW_GATEWAY_PASSWORD)");
	...
	if (!isLoopbackHost(bindHost) && !hasSharedSecret && authMode !== "trusted-proxy") throw new Error(`refusing to bind gateway to ${bindHost}:${params.port} without auth (set gateway.auth.token/password, or set OPENPAW_GATEWAY_TOKEN/OPENPAW_GATEWAY_PASSWORD)`);
...
const A2UI_PATH = "/__openpaw__/a2ui";
const CANVAS_HOST_PATH = "/__openpaw__/canvas";
const CANVAS_WS_PATH = "/__openpaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.openpawCanvasA2UIAction.postMessage(...)
  // - Android: window.openpawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["openpawCanvasA2UIAction"];
  ...
  globalThis.openpawPostMessage = postToNode;
  globalThis.openpawSendUserAction = sendUserAction;
...
(() => {
  ...
  const hasIOS = () =>
    !!(
      ...
      window.webkit.messageHandlers.openpawCanvasA2UIAction
    );
  const hasAndroid = () =>
    !!(
      (window.openpawCanvasA2UIAction &&
        typeof window.openpawCanvasA2UIAction.postMessage === "function")
    );
  const hasHelper = () => typeof window.openpawSendUserAction === "function";
  statusEl.innerHTML =
    "Bridge: " +
  ...
  function send(name, sourceComponentId) {
    ...
    const sendUserAction =
      typeof window.openpawSendUserAction === "function"
        ? window.openpawSendUserAction
        : undefined;
...
function isDisabledByEnv() {
	if (isTruthyEnvValue(process.env.OPENPAW_SKIP_CANVAS_HOST)) return true;
	if (isTruthyEnvValue(process.env.OPENPAW_SKIP_CANVAS_HOST)) return true;
	if (process.env.VITEST) return true;
	return false;
}
		...
		try {
			...
			if (!opened) {
				if (urlPath === "/" || urlPath.endsWith("/")) {
					res.statusCode = 404;
					res.setHeader("Content-Type", "text/html; charset=utf-8");
					res.end(`<!doctype html><meta charset="utf-8" /><title>OpenPaw Canvas</title><pre>Missing file.\nCreate ${rootDir}/index.html</pre>`);
					return true;
				}
				res.statusCode = 404;
				res.setHeader("Content-Type", "text/plain; charset=utf-8");
...
const CANVAS_CAPABILITY_PATH_PREFIX = "/__openpaw__/cap";
...
const CONTROL_UI_BOOTSTRAP_CONFIG_PATH = "/__openpaw/control-ui-config.json";
...
function resolveAgentIdFromHeader(req) {
	const raw = getHeader(req, "x-openpaw-agent-id")?.trim() || getHeader(req, "x-openpaw-agent")?.trim() || "";
	if (!raw) return;
...
function resolveAgentIdFromModel(model) {
	...
	if (!raw) return;
	const agentId = (raw.match(/^openpaw[:/](?<agentId>[a-z0-9][a-z0-9_-]{0,63})$/i) ?? raw.match(/^agent:(?<agentId>[a-z0-9][a-z0-9_-]{0,63})$/i))?.groups?.agentId;
	if (!agentId) return;
...
function resolveAgentResponseText(result) {
	...
	if (!Array.isArray(payloads) || payloads.length === 0) return "No response from OpenPaw.";
...
async function handleOpenResponsesHttpRequest(req, res, opts) {
	...
	unsubscribe = onAgentEvent((evt) => {
		...
		if (evt.stream === "lifecycle") {
			const phase = evt.data?.phase;
			if (phase === "end" || phase === "error") requestFinalize(phase === "error" ? "failed" : "completed", accumulatedText || "No response from OpenPaw.");
		}
	});
	req.on("close", () => {
		closed = true;
...
async function handleToolsInvokeHttpRequest(req, res, opts) {
	...
	const accountId = getHeader(req, "x-openpaw-account-id")?.trim() || void 0;
...
function createHooksRequestHandler(opts) {
	...
	return async (req, res) => {
		...
		if (url.searchParams.has("token")) {
			res.statusCode = 400;
			res.setHeader("Content-Type", "text/plain; charset=utf-8");
			res.end("Hook token must be provided via Authorization: Bearer <token> or X-OpenPaw-Token header (query parameters are not allowed).");
			return true;
		}
...
async function acquireGatewayLock(opts = {}) {
	...
	if (env.OPENPAW_ALLOW_MULTI_GATEWAY === "1" || !allowInTests && (env.VITEST || env.NODE_ENV === "test")) return null;
...
function logGatewayStartup(params) {
	...
	if (enabledDangerousFlags.length > 0) {
		const warning = `security warning: dangerous config flags enabled: ${enabledDangerousFlags.join(", ")}. Run \`openpaw security audit\`.`;
...
*/
const IMMUTABLE_SOURCES = new Set(["openpaw-bundled"]);
...
async function loadInternalHooks(cfg, workspaceDir, opts) {
	...
	for (const handlerConfig of handlers) try {
		...
		const mod = await import(buildImportUrl(modulePath, "openpaw-workspace"));
...
async function startGatewaySidecars(params) {
	...
	if (!(isTruthyEnvValue(process.env.OPENPAW_SKIP_CHANNELS) || isTruthyEnvValue(process.env.OPENPAW_SKIP_PROVIDERS))) try {
		await params.startChannels();
	} catch (err) {
		params.logChannels.error(`channel startup failed: ${String(err)}`);
	}
	else params.logChannels.info("skipping channel start (OPENPAW_SKIP_CHANNELS=1 or OPENPAW_SKIP_PROVIDERS=1)");
...
async function startGatewayServer(port = 18789, opts = {}) {
	const minimalTestGateway = process.env.VITEST === "1" && process.env.OPENPAW_TEST_MINIMAL_GATEWAY === "1";
	...
	if (configSnapshot.legacyIssues.length > 0) {
		...
		if (!migrated) throw new Error(`Legacy config entries detected but auto-migration failed. Run "${formatCliCommand("openpaw doctor")}" to migrate.`);
	...
	else log.warn("Gateway auth token was missing. Generated a runtime token for this startup without changing config; restart will generate a different token. Persist one with `openpaw config set gateway.auth.mode token` and `openpaw config set gateway.auth.token <token>`.");
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-DQk6d_Ts.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-C6XlXNEG.js").then((n) => n.n);
...
const resolveDevWorkspaceDir = (env = process.env) => {
	...
	if (env.OPENPAW_PROFILE?.trim().toLowerCase() === "dev") return baseDir;
...
async function ensureDevWorkspace(dir) {
	...
	const [agents, soul, tools, identity, user] = await Promise.all([
		loadDevTemplate("AGENTS.dev.md", `# AGENTS.md - OpenPaw Dev Workspace\n\nDefault dev workspace for openpaw gateway --dev.\n`),
...
* - OPENPAW_NO_RESPAWN=1: caller should keep in-process restart behavior (tests/dev)
* - otherwise: spawn detached child with current argv/execArgv, then caller exits
*/
function restartGatewayProcessWithFreshPid() {
	if (isTruthy(process.env.OPENPAW_NO_RESPAWN)) return { mode: "disabled" };
...
async function runGatewayLoop(params) {
	...
	const handleRestartAfterServerClose = async () => {
		...
		else gatewayLog$1.info("restart mode: in-process restart (OPENPAW_NO_RESPAWN)");
...
async function runGatewayCommand$1(opts) {
	...
	if (opts.rawStream) process.env.OPENPAW_RAW_STREAM = "1";
	const rawStreamPath = toOptionString(opts.rawStreamPath);
	if (rawStreamPath) process.env.OPENPAW_RAW_STREAM_PATH = rawStreamPath;
	...
	if (opts.token) {
		...
		if (token) process.env.OPENPAW_GATEWAY_TOKEN = token;
	}
	...
	if (!opts.allowUnconfigured && mode !== "local") {
		if (!configExists) defaultRuntime.error(`Missing config. Run \`${formatCliCommand("openpaw setup")}\` or set gateway.mode=local (or pass --allow-unconfigured).`);
		else {
...
function registerGatewayCli(program) {
	const gateway = addGatewayRunCommand(program.command("gateway").description("Run, inspect, and query the WebSocket Gateway").addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatHelpExamples([
		["openpaw gateway run", "Run the gateway in the foreground."],
		["openpaw gateway status", "Show service status and probe reachability."],
		["openpaw gateway discover", "Find local and wide-area gateway beacons."],
		["openpaw gateway call health", "Call a gateway RPC method directly."]
