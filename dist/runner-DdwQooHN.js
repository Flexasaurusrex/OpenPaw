import { m as resolveAgentModelPrimaryValue, p as resolveAgentModelFallbackValues } from "./agent-scope-9aJRv6zx.js";
import { J as logVerbose, Z as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-DWLvTobT.js";
import { _ as runExec } from "./workspace-DlPWdeFR.js";
import { t as normalizeChatType } from "./chat-type-uz-WJTy4.js";
import { _ as kindFromMime, d as detectMime, h as isAudioFileName, p as getFileExtension } from "./image-ops-B-YON1BR.js";
import { b as resolveOpenPawAgentDir, i as resolveApiKeyForProvider, j as normalizeProviderId, r as requireApiKey, z as normalizeGoogleModelId } from "./model-auth-CqKxd6-7.js";
import { f as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, h as resolveIMessageAttachmentRoots, m as mergeInboundPathRoots, n as loadConfig, p as isInboundPathAllowed } from "./config-CMJyaS_f.js";
import { t as describeImageWithModel, w as ensureOpenPawModelsJson } from "./image-DxsqHe5T.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-nBaq0Wti.js";
import { n as fetchWithTimeout } from "./fetch-timeout-BheTNyes.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-C0-RjmYc.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-nWQl2qU_.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-CMts9lz5.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenPawAgentDir());
