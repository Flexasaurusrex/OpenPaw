...
import { c as formatLocalIsoWithOffset, m as clearActiveProgressLine } from "./subsystem-BlU6Lg5x.js";
...
function createLogWriters() {
	const writer = createSafeStreamWriter({
		...
		onBrokenPipe: (err, stream) => {
			...
			const message = `openpaw logs: output ${stream === process.stdout ? "stdout" : "stderr"} closed (${code}). Stopping tail.`;
			try {
