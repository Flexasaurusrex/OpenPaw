...
import { a as extractArchive, c as resolveArchiveKind, l as resolvePackedRootDir, o as fileExists } from "./install-safe-path-DN73ttZx.js";
...
async function installPackageDir(params) {
	...
	if (params.mode === "update" && await fileExists(params.targetDir)) {
		const backupRoot = path.join(path.dirname(params.targetDir), ".openpaw-install-backups");
