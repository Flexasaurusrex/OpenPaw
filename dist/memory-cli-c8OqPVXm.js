...
import { C as parseDurationMs, i as loadConfig, ut as splitShellArgs } from "./config-DUiZpzJa.js";
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-B6UYhnJ6.js").then((n) => n.t);
