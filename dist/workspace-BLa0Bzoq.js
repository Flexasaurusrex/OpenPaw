...
import { a as isPathInsideWithRealpath, n as MANIFEST_KEY } from "./legacy-names-BiuaFIgp.js";
...
function shouldIncludeHook(params) {
	...
	if (!(entry.hook.source === "openpaw-plugin") && hookConfig?.enabled === false) return false;
