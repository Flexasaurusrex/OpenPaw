...
import { Lt as resolveOpenPawAgentDir } from "./model-selection-DBzxxd2t.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-AIqY2jfU.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenPawAgentDir());
