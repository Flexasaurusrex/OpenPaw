...
import { t as ensurePiAuthJsonFromAuthProfiles } from "./pi-auth-json-DLmh5LD-.js";
import { r as resolveForwardCompatModel } from "./model-N-4PKrha.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-CwESh4K1.js";
import { C as parseDurationMs, i as loadConfig } from "./config-DcMGW7oZ.js";
import { _n as maskApiKey, bn as formatRemainingShort, in as loadProviderUsageSummary, on as formatUsageWindowSummary, s as runEmbeddedPiAgent, sn as resolveUsageProviderId, vn as DEFAULT_OAUTH_WARN_MS, vt as describeFailoverError, yn as buildAuthHealthSummary } from "./subagent-registry-CxSu1VdQ.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-DXBvtSww.js";
import { t as ensureOpenPawModelsJson } from "./models-config-DsL-XOw3.js";
import { n as loadModelCatalog } from "./model-catalog-CIioIMi0.js";
import { r as withProgressTotals } from "./progress-C3lmnWTa.js";
import { f as openUrl } from "./onboard-helpers-CfGs7sWP.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-DLqE-O7K.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-GERiBuA-.js";
import { n as logConfigUpdated } from "./logging-D961S29j.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-Sw8pQJ-Y.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-DcMGW7oZ.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./auth-profiles-F3rq6gIp.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-N-4PKrha.js").then((n) => n.t);
