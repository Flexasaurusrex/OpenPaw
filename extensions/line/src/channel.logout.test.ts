import type { OpenPawConfig, PluginRuntime, ResolvedLineAccount } from "openpaw/plugin-sdk";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: OpenPawConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: OpenPawConfig; accountId: string }): Promise<{
