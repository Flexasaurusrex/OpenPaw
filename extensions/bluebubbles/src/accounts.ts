...
export function listBlueBubblesAccountIds(cfg: OpenPawConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: OpenPawConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: OpenPawConfig): ResolvedBlueBubblesAccount[] {
