...
import { resolveChannelMediaMaxBytes, type OpenPawConfig } from "openpaw/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: OpenPawConfig; accountId?: string }): string[] {
