...
export function listMattermostAccountIds(cfg: OpenPawConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OpenPawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OpenPawConfig): ResolvedMattermostAccount[] {
