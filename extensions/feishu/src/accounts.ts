...
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "openpaw/plugin-sdk/account-id";
import type {
  FeishuConfig,
  FeishuAccountConfig,
  FeishuDomain,
 ...
 */
function listConfiguredAccountIds(cfg: PawbotConfig): string[] {
 ...
 */
export function listFeishuAccountIds(cfg: PawbotConfig): string[] {
 ...
 */
export function resolveDefaultFeishuAccountId(cfg: PawbotConfig): string {
 ...
 */
function mergeFeishuAccountConfig(cfg: PawbotConfig, accountId: string): FeishuConfig {
 ...
 */
export function listEnabledFeishuAccounts(cfg: PawbotConfig): ResolvedFeishuAccount[] {
