...
import type { ReplyPayload, OpenPawConfig } from "openpaw/plugin-sdk";
import { createReplyPrefixOptions } from "openpaw/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as OpenPawConfig;
