...
export function listGoogleChatAccountIds(cfg: OpenPawConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OpenPawConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: OpenPawConfig): ResolvedGoogleChatAccount[] {
