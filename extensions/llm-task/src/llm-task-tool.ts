...
export function createLlmTaskTool(api: OpenPawPluginApi) {
  return {
    name: "llm-task",
    label: "LLM Task",
    description:
      "Run a generic JSON-only LLM task and return schema-validated JSON. Designed for orchestration from Cat workflows via openpaw.invoke.",
