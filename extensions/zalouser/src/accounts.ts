...
export function listZalouserAccountIds(cfg: OpenPawConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OpenPawConfig): string {
...
function mergeZalouserAccountConfig(cfg: OpenPawConfig, accountId: string): ZalouserAccountConfig {
