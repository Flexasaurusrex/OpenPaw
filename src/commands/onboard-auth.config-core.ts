...
export function applyMoonshotProviderConfigCn(cfg: OpenPawConfig): OpenPawConfig {
...
export function applyMoonshotConfigCn(cfg: OpenPawConfig): OpenPawConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: OpenPawConfig): OpenPawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: OpenPawConfig): OpenPawConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: OpenPawConfig): OpenPawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: OpenPawConfig): OpenPawConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: OpenPawConfig): OpenPawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: OpenPawConfig): OpenPawConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: OpenPawConfig): OpenPawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: OpenPawConfig): OpenPawConfig {
...
export function applyQianfanProviderConfig(cfg: OpenPawConfig): OpenPawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: OpenPawConfig): OpenPawConfig {
