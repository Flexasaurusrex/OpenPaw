...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status"; cfg?: OpenPawConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__openpawMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__openpawMcporterColdStartWarned;
  });
