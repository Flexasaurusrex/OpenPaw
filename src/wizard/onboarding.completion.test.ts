...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("openpaw");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "openpaw");
