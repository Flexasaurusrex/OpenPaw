...
describe("agent components", () => {
  const createCfg = (): OpenPawConfig => ({}) as OpenPawConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/openpaw-sessions-test.json");
  });
