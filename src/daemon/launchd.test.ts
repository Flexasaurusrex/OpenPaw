...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.openpaw.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", OPENPAW_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.openpaw.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when OPENPAW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.openpaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when OPENPAW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", OPENPAW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.openpaw.jbphoenix.plist",
    },
    {
      name: "prefers OPENPAW_LAUNCHD_LABEL over OPENPAW_PROFILE",
      env: {
        HOME: "/Users/test",
    ...
    {
      name: "trims whitespace from OPENPAW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        OPENPAW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty OPENPAW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        OPENPAW_PROFILE: "myprofile",
        OPENPAW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.openpaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
