...
describe("infra parsing", () => {
  ...
  describe("isMainModule", () => {
    ...
    it("returns true for dist/entry.js when launched via openpaw.mjs wrapper", () => {
      expect(
        isMainModule({
          currentFile: "/repo/dist/entry.js",
          argv: ["node", "/repo/openpaw.mjs"],
          cwd: "/repo",
          env: {},
          wrapperEntryPairs: [{ wrapperBasename: "openpaw.mjs", entryBasename: "entry.js" }],
        }),
      ).toBe(true);
    });
