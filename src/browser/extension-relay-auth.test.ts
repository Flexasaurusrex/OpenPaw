...
import {
  probeAuthenticatedOpenPawRelay,
...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated openpaw relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedOpenPawRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-openpaw-relay-token",
