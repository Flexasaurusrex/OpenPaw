...
import { createOpenPawCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/openpaw/openpaw/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt") {
          try {
            sessionManager.appendCustomEntry("openpaw:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/openpaw/openpaw/issues/8643
