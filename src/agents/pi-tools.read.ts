...
function resolveAdaptiveReadMaxBytes(options?: OpenPawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createOpenPawReadTool(base, {
...
export function createOpenPawReadTool(
  base: AnyAgentTool,
  options?: OpenPawReadToolOptions,
): AnyAgentTool {
