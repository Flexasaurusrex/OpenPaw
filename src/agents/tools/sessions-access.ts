...
export function resolveSessionToolsVisibility(cfg: OpenPawConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: OpenPawConfig): "spawned" | "all" {
