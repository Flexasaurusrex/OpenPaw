...
function asOpenPawConfig(config: Partial<OpenPawConfig>): OpenPawConfig {
  return config as OpenPawConfig;
}

function createToolConfig() {
  return asOpenPawConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: OpenPawConfig = createToolConfig()) {
