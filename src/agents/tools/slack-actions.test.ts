...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): OpenPawConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: OpenPawConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: OpenPawConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
