...
describe("resolveDefaultAgentWorkspaceDir", () => {
  it("uses OPENPAW_HOME for default workspace resolution", () => {
    const dir = resolveDefaultAgentWorkspaceDir({
      OPENPAW_HOME: "/srv/openpaw-home",
      HOME: "/home/other",
    } as NodeJS.ProcessEnv);

    expect(dir).toBe(path.join(path.resolve("/srv/openpaw-home"), ".openpaw", "workspace"));
  });
});

const WORKSPACE_STATE_PATH_SEGMENTS = [".openpaw", "workspace-state.json"] as const;
