...
// Prefix for OpenPaw-generated action IDs to scope our handler
const OPENPAW_ACTION_PREFIX = "openpaw:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${OPENPAW_ACTION_PREFIX}`);

  // Handle OpenPaw modal submissions with callback_ids scoped by our prefix.
