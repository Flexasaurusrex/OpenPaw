...
CDP_PORT="${OPENPAW_BROWSER_CDP_PORT:-${PAWBOT_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${OPENPAW_BROWSER_CDP_SOURCE_RANGE:-${PAWBOT_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${OPENPAW_BROWSER_VNC_PORT:-${PAWBOT_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${OPENPAW_BROWSER_NOVNC_PORT:-${PAWBOT_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${OPENPAW_BROWSER_ENABLE_NOVNC:-${PAWBOT_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${OPENPAW_BROWSER_HEADLESS:-${PAWBOT_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${OPENPAW_BROWSER_NO_SANDBOX:-${PAWBOT_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${OPENPAW_BROWSER_NOVNC_PASSWORD:-${PAWBOT_BROWSER_NOVNC_PASSWORD:-}}"
